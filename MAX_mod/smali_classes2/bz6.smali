...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lbc6;)V
    .registers 4
    ...
    iput-object p1, p0, Lbz6;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lbz6;->o:Landroid/graphics/Rect;

    const/4 p1, 0x3

    iput p1, p0, Lbz6;->r0:I

    const p1, 0x3f666666    # 0.9f

    iput p1, p0, Lbz6;->s0:F
    ...
    iput-object p1, p0, Lbz6;->t0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lbz6;->u0:Landroid/graphics/Matrix;
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILzy6;)V
    .registers 20
    ...
    sget-object v9, Lzy6;->o:Lzy6;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lzy6;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lbc6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lbz6;->o:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Lbz6;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Laz6;->$EnumSwitchMapping$0:[I
    ...
    invoke-static {v4}, Lr73;->I([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {v10, v11, v9}, Lpxa;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lbz6;->a(Landroid/graphics/Canvas;FFFILzy6;)V

    sget-object v6, Lzy6;->c:Lzy6;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lbz6;->v0:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Lbz6;->u0:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lbz6;->t0:Landroid/graphics/Paint;
    ...
    sget-object v8, Lzy6;->o:Lzy6;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Lbz6;->a(Landroid/graphics/Canvas;FFFILzy6;)V
