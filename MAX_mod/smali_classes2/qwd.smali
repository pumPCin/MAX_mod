...
# direct methods
.method public constructor <init>(Lzc;Lfv0;Lss3;Lq95;Ltwg;)V
    .registers 6

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lqwd;->a:Lzc;

    iput-object p2, p0, Lqwd;->b:Lfv0;

    iput-object p4, p0, Lqwd;->c:Lq95;

    iput-object p5, p0, Lqwd;->d:Ltwg;
...
.method public final a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lqwd;->a:Lzc;

    invoke-virtual {v5, v3, v4}, Lzc;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p1, v1}, Lc2e;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v3, v4, v5, v1}, Lzkd;-><init>(JLjava/util/List;)V

    const/4 v1, 0x1

    iput-boolean v1, v3, Lzkd;->j:Z

    iput-object p2, v3, Lzkd;->h:Ljava/lang/String;

    iput-object v2, v3, Lzkd;->i:Ljava/util/List;
...
.method public final b(Lru/ok/tamtam/android/util/share/ShareData;Ljava/util/List;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, v12, v6, v5}, Lqwd;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v12, v13, v5}, Lqwd;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v14, v6, v5}, Lqwd;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    :cond_6
    invoke-virtual {v0, v14, v13, v5}, Lqwd;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v6, v13, v5}, Lqwd;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-direct {v14, v6, v7, v10, v13}, Leld;-><init>(JLjava/lang/String;Ld10;)V

    iput-boolean v12, v14, Leld;->i:Z
    ...
    invoke-direct {v8, v6, v7}, Lbld;-><init>(J)V

    iput-object v5, v8, Lvkd;->g:Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Lm7g;->m(Ljava/lang/CharSequence;)Z

    move-result v6

    if-nez v6, :cond_12

    new-instance v16, Leld;
    ...
    invoke-direct/range {v16 .. v21}, Leld;-><init>(JLjava/lang/String;ZLjava/util/List;)V
    ...
    invoke-direct {v7, v3, v4, v6, v8}, Lgkd;-><init>(JLjava/lang/Object;I)V

    const/4 v3, 0x0

    iput-object v3, v7, Lbld;->e:Ljava/lang/String;

    new-instance v4, Ldld;

    invoke-direct {v4, v7}, Ldld;-><init>(Lgkd;)V

    iget-object v6, v0, Lqwd;->d:Ltwg;

    invoke-virtual {v6, v4}, Ltwg;->a(Lckd;)V
