...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v2, Lj3c;->markdown_dot_size:I
    ...
    sget v3, Lj3c;->markdown_button_size:I
    ...
    iput-object v5, p0, Lp68;->a:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v7, v8}, Li4h;->T(Landroid/graphics/drawable/Drawable;I)V

    invoke-virtual {v6, v7}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iput-object v6, p0, Lp68;->b:Landroid/view/View;
    ...
    :cond_0
    sget-object v2, Lldc;->MarkdownItemView:[I
    ...
    sget v0, Lldc;->MarkdownItemView_miv_title:I
    ...
    invoke-virtual {p0, v0}, Lp68;->setTitle(I)V

    :cond_1
    sget v0, Lldc;->MarkdownItemView_miv_highlight_title:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    invoke-virtual {p0, v0, v1}, Lp68;->a(ZZ)V

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0}, Lp68;->c()V
...
.method public final a(ZZ)V
    ...
    invoke-direct {p1, v0, v1}, Lnf;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V

    iget-boolean v2, p0, Lp68;->c:Z
    ...
    invoke-direct {p1, v1, v0}, Lnf;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v1, p1, Lnf;->b:Ljava/lang/Float;
    ...
    iget-object v0, p0, Lp68;->o:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Lp68;->o:Landroid/animation/ObjectAnimator;

    :cond_4
    iget-object v0, p1, Lnf;->a:Ljava/lang/Float;
    ...
    iget-object p2, p2, Lvg;->a:Liy5;

    const-wide/16 v1, 0xc8

    invoke-virtual {v0, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-boolean v1, p0, Lp68;->c:Z

    if-eqz v1, :cond_5

    invoke-virtual {p2}, Liy5;->j()Landroid/view/animation/Interpolator;
    ...
    :cond_5
    invoke-virtual {p2}, Liy5;->k()Landroid/view/animation/Interpolator;
    ...
    invoke-direct {p2, p0, v1, p1}, Lkf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final c()V
    ...
    iget-object p0, p0, Lp68;->a:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object p0, p0, Lp68;->o:Landroid/animation/ObjectAnimator;
