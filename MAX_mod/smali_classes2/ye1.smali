...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lye1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Lfec;Landroid/opengl/EGLContext;[ILmz8;Ljava/lang/String;)V
    .registers 19

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lye1;->a:Lfec;

    move-object/from16 v0, p4

    iput-object v0, p0, Lye1;->b:Lmz8;
    ...
    iput-object v0, p0, Lye1;->c:Landroid/os/HandlerThread;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lye1;->g:Landroid/opengl/EGLSurface;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lye1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v2, p0, Lye1;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, p1, v4, v5}, Lrzg;-><init>(Landroid/os/Looper;Lfec;Ljava/lang/String;Lmz8;)V

    iput-object v3, p0, Lye1;->k:Lrzg;
    ...
    invoke-direct {v0, p0, v5, p2, v4}, Lj5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lye1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lye1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lye1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lye1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lye1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lbc6;)Z
    .registers 5

    :try_start_0
    iget-object v0, p0, Lye1;->k:Lrzg;

    new-instance v1, Lxe1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, p0, v2}, Lxe1;-><init>(Lbc6;Lye1;I)V
    ...
    iget-object v0, p0, Lye1;->j:Ljava/lang/String;

    const-string v1, "OpenGL tread died, is it fine?"

    iget-object p0, p0, Lye1;->a:Lfec;
...
.method public final d(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lye1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lye1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
