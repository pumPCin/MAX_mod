...
# direct methods
.method public constructor <init>(Ln4a;Lorg/webrtc/CameraVideoCapturer;Lpxe;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLfec;)V
    .registers 12
    ...
    iput-object p7, p0, Lhy1;->e:Lfec;

    check-cast p1, Lbd4;

    new-instance p7, Lsk6;

    new-instance v2, Lqza;

    new-instance v3, Ld02;

    iget-object p1, p1, Lbd4;->a:Lfec;

    invoke-direct {v3, p1}, Ld02;-><init>(Lfec;)V

    invoke-direct {v2, p2, v3, p1}, Lqza;-><init>(Lorg/webrtc/CameraVideoCapturer;Ld02;Lfec;)V

    const/16 p1, 0x1a

    invoke-direct {p7, p1, v2}, Lsk6;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lhy1;->c:Lsk6;

    iput-object p3, p0, Lhy1;->d:Lpxe;
...
.method public final a()V
    ...
    invoke-direct {v0, v3}, Lw47;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lsq3;->o(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lyv7;->f(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lhy1;->e:Lfec;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lfec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lhy1;->e:Lfec;
    ...
    invoke-interface {v4, v6, v7}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v8, v7, Lqx7;->r:Lhy1;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lqx7;->n:Lfec;
    ...
    invoke-interface {v8, v10, v11, v9}, Lfec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lqx7;->y:Lt4g;

    iget-object v8, v7, Lem3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lyv7;->f(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lt4g;->k:Lorg/webrtc/Size;
    ...
    iget-object v4, p0, Lhy1;->c:Lsk6;

    iget-object v4, v4, Lsk6;->b:Ljava/lang/Object;

    check-cast v4, Lqza;

    invoke-virtual {v4, v2, v0, v3}, Lqza;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lqza;->startCapture(III)V
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lqza;->stopCapture()V
