...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Lfec;)V
    .registers 5
    ...
    iput-object v0, p0, Lq64;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lq64;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lq64;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Lq64;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Lq64;->b:Lfec;
    ...
    invoke-direct {p2, p0, p1, v1, v0}, Lmgb;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
# virtual methods
.method public final a(Ln0d;)V
    .registers 2

    if-eqz p1, :cond_0

    iget-object p0, p0, Lq64;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object p0, p0, Lq64;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, p0, Lq64;->b:Lfec;

    invoke-interface {v4, v1, v3, v2}, Lfec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
