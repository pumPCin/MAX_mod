...
.method public constructor <init>(JJJILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lu00;Ljava/lang/Long;ZJ)V
    ...
    iput-wide p3, p0, Leu2;->o:J

    iput-wide p5, p0, Leu2;->X:J

    iput p7, p0, Leu2;->Y:I

    iput-object p8, p0, Leu2;->Z:Ljava/lang/String;

    iput-boolean p9, p0, Leu2;->r0:Z

    iput-object p10, p0, Leu2;->s0:Ljava/lang/String;

    iput-object p11, p0, Leu2;->t0:Ljava/util/Map;

    iput-object p12, p0, Leu2;->u0:Ljava/lang/String;

    iput-object p13, p0, Leu2;->v0:Ljava/lang/String;

    iput-object p14, p0, Leu2;->w0:Lu00;

    iput-object p15, p0, Leu2;->x0:Ljava/lang/Long;

    move/from16 p1, p16

    iput-boolean p1, p0, Leu2;->y0:Z

    move-wide/from16 p1, p17

    iput-wide p1, p0, Leu2;->z0:J
...
.method public final e(Lsxe;)V
    ...
    iget-object v0, p1, Lfu2;->c:Lt72;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Leu2;->t()V
...
.method public final f()[B
    ...
    iget-wide v1, p0, Leu2;->X:J

    iput-wide v1, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->chatServerId:J

    const/4 v1, 0x1

    iget-object v2, p0, Leu2;->u0:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Leu2;->v0:Ljava/lang/String;
    ...
    :goto_1
    iget-object v2, p0, Leu2;->w0:Lu00;
    ...
    :cond_2
    iget-object v2, p0, Leu2;->x0:Ljava/lang/Long;
    ...
    :goto_2
    iget-boolean v2, p0, Leu2;->y0:Z

    iput-boolean v2, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->notifyPin:Z

    iget-object p0, p0, Leu2;->s0:Ljava/lang/String;
...
.method public final h()Lpxe;
    ...
    iget-object v1, v0, Leu2;->x0:Ljava/lang/Long;
    ...
    :goto_1
    iget-boolean v14, v0, Leu2;->y0:Z

    iget-wide v3, v0, Leu2;->z0:J

    move-wide v15, v3

    iget-wide v3, v0, Leu2;->X:J

    iget-object v6, v0, Leu2;->Z:Ljava/lang/String;

    iget-boolean v7, v0, Leu2;->r0:Z

    iget-object v8, v0, Leu2;->s0:Ljava/lang/String;

    iget-object v9, v0, Leu2;->t0:Ljava/util/Map;

    iget-object v10, v0, Leu2;->u0:Ljava/lang/String;

    iget-object v11, v0, Leu2;->v0:Ljava/lang/String;

    iget-object v12, v0, Leu2;->w0:Lu00;
...
.method public final j(Lcxe;)V
    ...
    iget-object v0, p0, Leu2;->u0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Leu2;->v0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Leu2;->x0:Ljava/lang/Long;

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0}, Leu2;->d()V
...
.method public final t()V
    ...
    sget-object v0, Lfb2;->o:Lfb2;

    invoke-virtual {p0, v1, v2, v0}, Lza2;->W(JLfb2;)V
