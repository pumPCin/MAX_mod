...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v1}, Loba;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v4}, Loba;->setAvatarShape(Liba;)V

    iput-object v3, v0, Lyud;->a:Loba;
    ...
    invoke-static {v8, v4}, Lv2f;->d(Lv2f;Landroid/widget/TextView;)V

    sget-object v8, Lyu4;->t0:Lbx9;

    invoke-virtual {v8, v4}, Lbx9;->l(Landroid/view/View;)Lera;
    ...
    iput-object v4, v0, Lyud;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    sget-object v12, Lclf;->o:Lv2f;

    invoke-static {v12, v11}, Lv2f;->d(Lv2f;Landroid/widget/TextView;)V

    invoke-virtual {v8, v11}, Lbx9;->l(Landroid/view/View;)Lera;
    ...
    iget v13, v13, Lh1f;->j:I

    invoke-virtual {v11, v13}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v11, v0, Lyud;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v12, v13}, Lv2f;->d(Lv2f;Landroid/widget/TextView;)V

    invoke-virtual {v8, v13}, Lbx9;->l(Landroid/view/View;)Lera;
    ...
    iput-object v13, v0, Lyud;->o:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v2, v7, v7}, Lm73;-><init>(II)V

    invoke-virtual {v9, v2}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v9, v5}, Landroid/widget/TextView;->setGravity(I)V

    invoke-static {v12, v9}, Lv2f;->d(Lv2f;Landroid/widget/TextView;)V
    ...
    iput-object v9, v0, Lyud;->r0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v1, v7, v7}, Lm73;-><init>(II)V
    ...
    iput-object v2, v0, Lyud;->s0:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v6, v8, v7}, Lm73;-><init>(II)V
...
.method private final setDivider(Z)V
    ...
    :goto_0
    iget-object p0, p0, Lyud;->o:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setNickname(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lyud;->r0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setPhoneNumber(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lyud;->c:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final onThemeChanged(Lera;)V
    ...
    iget-object v1, p0, Lyud;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lyud;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lyud;->r0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public setAlpha(F)V
    ...
    iget-object v0, p0, Lyud;->s0:Landroid/widget/LinearLayout;

    invoke-virtual {v0, p1}, Landroid/view/View;->setAlpha(F)V

    iget-object p0, p0, Lyud;->a:Loba;
...
.method public final setAvatarClickedListener(Lzb6;)V
    .registers 4
...
.method public final setNicknameClickListener(Lzb6;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setTopBarContent(Lfud;)V
    .registers 6

    iget-object v0, p1, Lfud;->b:Ljava/lang/String;

    iget-wide v1, p1, Lfud;->a:J

    invoke-static {v1, v2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    iget-object v2, p1, Lfud;->d:Ljava/lang/CharSequence;

    iget-object v3, p0, Lyud;->a:Loba;

    invoke-static {v3, v0, v1, v2}, Loba;->n(Loba;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lyud;->b:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v1, p1, Lfud;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lfud;->e:Ljava/lang/String;

    invoke-direct {p0, v0}, Lyud;->setPhoneNumber(Ljava/lang/String;)V

    iget-object p1, p1, Lfud;->f:Ljava/lang/String;

    invoke-direct {p0, p1}, Lyud;->setNickname(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {p0, p1}, Lyud;->setDivider(Z)V

    return-void
.end method

.method public final setUserPhoneClickListener(Lzb6;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
