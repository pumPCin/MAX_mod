...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lr0h;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lr0h;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lya6;->c(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Lya6;->c(ILjava/lang/String;)I
    ...
    iput v0, p0, Lr0h;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lya6;->a(ILjava/lang/String;)V
    ...
    iput v2, p0, Lr0h;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Lya6;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lr0h;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lya6;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lr0h;->texMatrixLoc:I
    ...
    iput v3, p0, Lr0h;->textureLocation:I
    ...
    iput v1, p0, Lr0h;->alphaLocation:I

    invoke-static {v3, p1}, Lya6;->a(ILjava/lang/String;)V

    new-instance p1, Lg0h;

    invoke-direct {p1, v0, v2}, Lg0h;-><init>(II)V

    iput-object p1, p0, Lr0h;->frame:Lg0h;
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Lr0h;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Lr0h;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lr0h;->firstFreeTexture:I
    ...
    iget p1, p0, Lr0h;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lr0h;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lr0h;->frame:Lg0h;

    iget-object v0, v0, Lg0h;->a:Lo0h;

    invoke-interface {v0}, Lo0h;->a()V

    iget p0, p0, Lr0h;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lr0h;->use()V

    iget-object v0, p0, Lr0h;->frame:Lg0h;

    iget-object v0, v0, Lg0h;->a:Lo0h;

    invoke-interface {v0}, Lo0h;->b()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    iget v0, p0, Lr0h;->programId:I

    invoke-static {v0, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iget-object p0, p0, Lr0h;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lr0h;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lr0h;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Lr0h;->firstFreeTexture:I

    iget-object v1, p0, Lr0h;->mvpMat:[F
    ...
    iput-object v1, p0, Lr0h;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lr0h;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lr0h;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lr0h;->programId:I
    ...
    iget v1, p0, Lr0h;->mvpMatrixLoc:I

    iget-object v2, p0, Lr0h;->mvpMat:[F
    ...
    iget v2, p0, Lr0h;->texMatrixLoc:I

    iget-object v4, p0, Lr0h;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lya6;->b(Ljava/lang/String;)V

    iget v0, p0, Lr0h;->textureLocation:I

    invoke-virtual {p0}, Lr0h;->getTarget()I

    move-result v1

    iget v2, p0, Lr0h;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lr0h;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lr0h;->alphaLocation:I

    iget v1, p0, Lr0h;->alpha:F
    ...
    iget-object v0, p0, Lr0h;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lr0h;->customParams:Ljava/util/HashMap;
