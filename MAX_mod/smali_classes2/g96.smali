...
# instance fields
.field public final X:Luyc;

.field public volatile Y:Lorg/webrtc/VpxEncoderWrapper;

.field public volatile Z:Lu96;
...
.field public volatile r0:Lu96;

.field public volatile s0:J

.field public final t0:Lf6f;

.field public final u0:Lf6f;
...
# direct methods
.method public constructor <init>(Lfec;Luyc;)V
    .registers 7
    ...
    iput-object v0, p0, Lg96;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lg96;->o:Lfec;

    iput-object p2, p0, Lg96;->X:Luyc;
    ...
    iput-object p1, p0, Lg96;->c:Lpx3;

    new-instance p1, Lf6f;

    invoke-direct {p1}, Lf6f;-><init>()V

    iput-object p1, p0, Lg96;->t0:Lf6f;

    new-instance p1, Lf6f;

    invoke-direct {p1}, Lf6f;-><init>()V

    iput-object p1, p0, Lg96;->u0:Lf6f;
...
.method public final a()V
    ...
    iget-object v0, p0, Lg96;->Y:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lg96;->t0:Lf6f;
    ...
    iput-wide v2, p0, Lg96;->s0:J

    :cond_0
    iget-object v0, p0, Lg96;->Z:Lu96;

    if-eqz v0, :cond_3

    iget-object p0, p0, Lg96;->Z:Lu96;
    ...
    iput-boolean v0, p0, Lu96;->h:Z

    :cond_2
    iget-object v0, p0, Lu96;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, Lu96;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lu96;->g:Lgzg;

    invoke-static {p0}, Lu96;->b(Lgzg;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lg96;->r0:Lu96;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lg96;->x0:J

    iget-wide v7, p0, Lg96;->b:J
    ...
    iget-object v5, v2, Lu96;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lu96;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lg96;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lg96;->x0:J

    iget-object p1, p0, Lg96;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lg96;->c:Lpx3;
    ...
    invoke-virtual {p1, v0}, Lpx3;->c(Ljava/lang/Runnable;)V

    return-void

    :catch_0
    iget-object p0, p0, Lg96;->o:Lfec;
...
.method public final onFrameDropped(I)V
    ...
    iget-object p0, p0, Lg96;->u0:Lf6f;

    invoke-virtual {p0}, Lf6f;->a()V
