...
# direct methods
.method public constructor <init>(Lfec;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .registers 16

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Laf1;->a:Lfec;

    iput-object p2, p0, Laf1;->b:Lorg/webrtc/EglBase$Context;
    ...
    iput-object v1, p0, Laf1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lye1;-><init>(Lfec;Landroid/opengl/EGLContext;[ILmz8;Ljava/lang/String;)V

    iput-object v1, p0, Laf1;->e:Lye1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Laf1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Laf1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Laf1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Laf1;->i:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lye1;->a:Lfec;

    invoke-interface {v1, v3, v4, v0}, Lfec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Laf1;->c:Loe;
...
.method public final a()V
    ...
    iget-object p0, p0, Laf1;->e:Lye1;

    iget-object v0, p0, Lye1;->a:Lfec;

    iget-object v1, p0, Lye1;->j:Ljava/lang/String;
    ...
    :try_start_0
    iget-boolean v2, p0, Lye1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lye1;->a:Lfec;

    iget-object p0, p0, Lye1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lye1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lye1;->k:Lrzg;
    ...
    iget-object v1, p0, Lye1;->a:Lfec;

    iget-object p0, p0, Lye1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lye1;Lhr1;Lorg/webrtc/VideoFrame;Lxi1;)V
    .registers 21
    ...
    iget-object v4, v2, Lze1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lye1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lye1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Laf1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lhr1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Laf1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lye1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Laf1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lye1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lye1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, Lhr1;->l:Lir1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Lir1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lir1;->h:J

    iget-wide v5, v1, Lir1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lir1;->i:J
