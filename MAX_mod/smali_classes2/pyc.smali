...
.method public constructor <init>(Lorg/webrtc/VideoFrame$TextureBuffer;ILandroid/os/Handler;Lorg/webrtc/YuvConverter;)V
    ...
    iput-object p1, p0, Lpyc;->a:Lorg/webrtc/VideoFrame$TextureBuffer;

    iput p2, p0, Lpyc;->b:I

    iput-object p3, p0, Lpyc;->c:Landroid/os/Handler;

    iput-object p4, p0, Lpyc;->d:Lorg/webrtc/YuvConverter;
...
.method public final cropAndScale(IIIIII)Lorg/webrtc/VideoFrame$Buffer;
    ...
    iget-object v0, p0, Lpyc;->a:Lorg/webrtc/VideoFrame$TextureBuffer;
    ...
    invoke-virtual {p0}, Lpyc;->getWidth()I
    ...
    invoke-virtual {p0}, Lpyc;->getHeight()I
    ...
    invoke-direct {v8, p1, p0}, Ls0b;-><init>(ILjava/lang/Object;)V

    iget-object v6, p0, Lpyc;->c:Landroid/os/Handler;

    iget-object v7, p0, Lpyc;->d:Lorg/webrtc/YuvConverter;
