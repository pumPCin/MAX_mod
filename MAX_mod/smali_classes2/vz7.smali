...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lvz7;->h:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lvz7;->i:J
...
.method public final a(I)V
    ...
    invoke-static {v2, v3}, Ldp5;->M(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v4, "b.log"

    invoke-static {v2, v4}, Ldp5;->M(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v4

    const-string v6, "stash-a.log"

    invoke-static {v2, v6}, Ldp5;->M(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v6

    const-string v7, "stash-b.log"

    invoke-static {v2, v7}, Ldp5;->M(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    sget-object v1, Luz7;->$EnumSwitchMapping$1:[I
    ...
    invoke-static {v1}, Lh2a;->c([Ljava/io/File;)Lhr;
    ...
    invoke-direct {v1, v3, v6}, Lpxa;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v3, Lpxa;

    invoke-direct {v3, v4, v2}, Lpxa;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v1, v3}, [Lpxa;
