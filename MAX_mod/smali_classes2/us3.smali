...
.method public constructor <init>(Lt39;)V
    ...
    iget-object p1, p0, Lus3;->c:Ljava/util/List;

    if-nez p1, :cond_0

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Lus3;->c:Ljava/util/List;

    :cond_0
    iget-object p1, p0, Lus3;->o:Ljava/util/List;

    if-nez p1, :cond_1

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Lus3;->o:Ljava/util/List;
...
.method public final c(Lt39;Ljava/lang/String;)V
    ...
    :goto_2
    iput-object p2, p0, Lus3;->c:Ljava/util/List;
    ...
    :goto_4
    iput-object p2, p0, Lus3;->o:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lus3;->c:Ljava/util/List;

    invoke-static {v0}, Lf4h;->h(Ljava/util/Collection;)I

    move-result v0

    iget-object v1, p0, Lus3;->o:Ljava/util/List;
