...
# static fields
.field public static final j:[Lv5g;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lv5g;->b:Lv5g;

    filled-new-array {v0, v1}, [Lv5g;

    move-result-object v0

    sput-object v0, Loh4;->j:[Lv5g;
...
.method public constructor <init>(Leuc;Lfec;Lp0b;Ltgd;)V
    ...
    iput-object p1, p0, Loh4;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Loh4;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Loh4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Loh4;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lsg1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object p0, p0, Loh4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1, p2}, Le5g;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Lnm3;-><init>(ILjava/lang/Object;)V
...
.method public final e(Lsg1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lmr8;-><init>(I)V

    iput-object v1, v2, Lmr8;->a:Ljava/lang/Object;

    iput-object p1, v2, Lmr8;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lmr8;->c()Lkr1;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Loh4;->p(Ljava/lang/String;Lkr1;Ljava/util/List;)V
...
.method public final f()V
    ...
    iget-object v0, p0, Loh4;->f:Ljava/util/concurrent/ConcurrentHashMap;

    monitor-enter v0

    :try_start_0
    iget-object v2, p0, Loh4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Le5g;->a:Lorg/webrtc/VideoSink;
    ...
    invoke-virtual {v0, p0, v1}, Ly0b;->i(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final p(Ljava/lang/String;Lkr1;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lmh4;-><init>(Loh4;Ljava/lang/String;Lkr1;Ljava/util/List;)V
...
.method public final u(Ljava/lang/String;Lkr1;Ljava/util/List;)V
    .registers 10
    ...
    :try_start_0
    iget-object v3, p0, Loh4;->g:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v1, p0, Loh4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lem3;->b:Ljava/lang/Object;
    ...
    invoke-interface {v1, v4, v0}, Lfec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Le5g;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Loh4;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Loh4;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Loh4;->i:Ljava/util/concurrent/ConcurrentHashMap;
