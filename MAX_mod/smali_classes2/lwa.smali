...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Llwa;->a:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Llwa;->b:Landroid/graphics/RectF;

    iput-object v0, p0, Llwa;->t0:[F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Llwa;->y0:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Llwa;->z0:Landroid/graphics/Paint;

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2, v0}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v2, p0, Llwa;->A0:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3, v0}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v3, p0, Llwa;->B0:Landroid/graphics/Paint;

    new-instance v4, Landroid/graphics/Paint;

    invoke-direct {v4, v0}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v4, p0, Llwa;->C0:Landroid/graphics/Paint;

    iput v1, p0, Llwa;->D0:I

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, Llwa;->E0:F

    iput v1, p0, Llwa;->F0:F

    const/4 v1, -0x1

    iput v1, p0, Llwa;->G0:I
    ...
    iput v5, p0, Llwa;->K0:I

    const/high16 v5, -0x74000000

    iput v5, p0, Llwa;->x0:I
    ...
    iput p1, p0, Llwa;->r0:I

    iput-boolean v0, p0, Llwa;->v0:Z
...
.method public final b()V
    ...
    iget-object v0, p0, Llwa;->a:Landroid/graphics/RectF;
    ...
    iput-object v1, p0, Llwa;->t0:[F

    iget-object p0, p0, Llwa;->y0:Landroid/graphics/Path;
...
.method public getCropViewRect()Landroid/graphics/RectF;
    ...
    iget-object p0, p0, Llwa;->a:Landroid/graphics/RectF;
...
.method public getFreestyleCropMode()I
    ...
    iget p0, p0, Llwa;->D0:I

    return p0
.end method

.method public getOverlayViewChangeListener()Lmwa;
    .registers 1

    iget-object p0, p0, Llwa;->L0:Lmwa;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Llwa;->w0:Z

    iget-object v1, p0, Llwa;->a:Landroid/graphics/RectF;

    if-eqz v0, :cond_0

    iget-object v0, p0, Llwa;->y0:Landroid/graphics/Path;
    ...
    iget-object v5, p0, Llwa;->z0:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v3, v4, v5}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    :cond_1
    iget-boolean v0, p0, Llwa;->v0:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Llwa;->t0:[F
    ...
    iget-object v3, p0, Llwa;->A0:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v3}, Landroid/graphics/Canvas;->drawLines([FLandroid/graphics/Paint;)V

    :cond_4
    iget-boolean v0, p0, Llwa;->u0:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Llwa;->B0:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v0}, Landroid/graphics/Canvas;->drawRect(Landroid/graphics/RectF;Landroid/graphics/Paint;)V

    :cond_5
    iget v0, p0, Llwa;->D0:I
    ...
    iget-object v7, p0, Llwa;->b:Landroid/graphics/RectF;
    ...
    iget-object p0, p0, Llwa;->C0:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-boolean p1, p0, Llwa;->M0:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x0

    iput-boolean p1, p0, Llwa;->M0:Z

    iget p1, p0, Llwa;->s0:F

    invoke-virtual {p0, p1}, Llwa;->setTargetAspectRatio(F)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, v1, Llwa;->a:Landroid/graphics/RectF;
    ...
    iput v7, v1, Llwa;->E0:F

    iput v7, v1, Llwa;->F0:F

    return v6

    :cond_4
    iget v0, v1, Llwa;->E0:F

    cmpg-float v0, v0, v16

    if-gez v0, :cond_5

    iput v2, v1, Llwa;->E0:F

    iput v3, v1, Llwa;->F0:F
    ...
    :pswitch_0
    iget v5, v1, Llwa;->E0:F

    sub-float v5, v2, v5

    iget v6, v1, Llwa;->F0:F
    ...
    :goto_2
    iget-object v5, v1, Llwa;->L0:Lmwa;
    ...
    :cond_7
    invoke-interface {v5}, Lmwa;->getMinOverlaySize()F

    move-result v5

    :goto_3
    iget-object v7, v1, Llwa;->L0:Lmwa;
    ...
    :cond_8
    invoke-interface {v7}, Lmwa;->getMinOverlaySize()F
    ...
    iget-object v4, v1, Llwa;->L0:Lmwa;

    if-eqz v4, :cond_f

    check-cast v4, Lone/me/image/crop/view/ImageCropView;

    iget-object v4, v4, Lone/me/image/crop/view/ImageCropView;->a:Llh6;

    invoke-virtual {v4}, Lkdf;->getCurrentImageCorners()[F

    move-result-object v4

    invoke-static {v4}, Lmu0;->C([F)Landroid/graphics/RectF;
    ...
    iget v0, v1, Llwa;->s0:F

    invoke-virtual {v1, v4, v0}, Llwa;->a(Landroid/graphics/RectF;F)V
    ...
    invoke-direct/range {v0 .. v5}, Lw05;-><init>(Landroid/view/View;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public setCropFrameColor(I)V
    ...
    iget-object p0, p0, Llwa;->B0:Landroid/graphics/Paint;
...
.method public setCropGridColor(I)V
    ...
    iget-object p0, p0, Llwa;->A0:Landroid/graphics/Paint;
...
.method public setOverlayViewChangeListener(Lmwa;)V
    .registers 2

    iput-object p1, p0, Llwa;->L0:Lmwa;
...
.method public setTargetAspectRatio(F)V
    ...
    invoke-virtual {p0, v0, p1}, Llwa;->a(Landroid/graphics/RectF;F)V

    iget-object p1, p0, Llwa;->L0:Lmwa;

    if-eqz p1, :cond_0

    check-cast p1, Lone/me/image/crop/view/ImageCropView;

    iget-object p1, p1, Lone/me/image/crop/view/ImageCropView;->a:Llh6;

    invoke-virtual {p1, v0}, Lga7;->setCropRect(Landroid/graphics/RectF;)V
