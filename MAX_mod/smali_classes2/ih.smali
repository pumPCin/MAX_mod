...
# static fields
.field public static final c:Leuc;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lih;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lzxa;->c(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Lqme;->S(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lih;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lih;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Lux0;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Lih;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lyg;->Y:Lyg;

    iget-object v12, v0, Lih;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Lyg;->r0:Lyg;

    invoke-virtual {v13, v12, v3}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Lyg;->s0:Lyg;

    invoke-virtual {v14, v12, v3}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Lyg;->w0:Lyg;

    invoke-virtual {v15, v12, v3}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Loh;

    instance-of v12, v3, Lmh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lnh;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lmq0;->p(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    :cond_12
    sget-object v0, Lyg;->Z:Lyg;

    invoke-virtual {v0, v12, v3}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    sget-object v0, Lzg;->o:Lzg;

    iget-object p0, p0, Lih;->a:Landroid/content/Context;

    invoke-virtual {v0, p0, p2}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v1, Lbh;->o:Lbh;

    invoke-virtual {v1, p0, p2}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Loh;

    sget-object v2, Lbh;->X:Lbh;

    invoke-virtual {v2, p0, p2}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Loh;

    sget-object v3, Lyg;->w0:Lyg;

    invoke-virtual {v3, p0, p2}, Lpxe;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Loh;

    instance-of p2, v1, Ljh;
    ...
    :cond_0
    instance-of p2, p0, Lnh;

    if-eqz p2, :cond_2

    new-instance p0, Lkh;

    invoke-direct {p0, v4}, Lkh;-><init>(F)V
    ...
    invoke-direct {p0, v3}, Ljh;-><init>(I)V

    :cond_2
    :goto_1
    instance-of p2, p0, Lkh;

    instance-of v5, p0, Lmh;

    const/4 v6, 0x0

    if-eqz v5, :cond_11

    instance-of p0, v1, Lmh;
    ...
    iget-object p2, p2, Lmh;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p2}, Lmq0;->o(Ljava/lang/String;)[La0b;
    ...
    iget-object v4, v4, Lmh;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v4}, Lmq0;->o(Ljava/lang/String;)[La0b;
    ...
    invoke-direct {v5}, Luxb;-><init>()V

    if-eqz v4, :cond_f

    invoke-static {p2, v4}, Lmq0;->a([La0b;[La0b;)Z
    ...
    iget-object p0, v1, Lmh;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0, v0, v6}, Lee5;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
