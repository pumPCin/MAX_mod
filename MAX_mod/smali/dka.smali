...
.field public final k:Laca;

.field public final l:Ly9e;

.field public final m:Lq95;

.field public final n:Lcka;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lqgb;Lz25;Ly9e;Laca;Lq95;Lcl7;Lo3f;Lcka;Lcl7;)V
    .registers 11
    ...
    iput-object p1, p0, Ldka;->c:Lh53;

    iput-object p5, p0, Ldka;->b:Laca;

    iput-object p7, p0, Ldka;->d:Lcl7;

    iput-object p8, p0, Ldka;->e:Lo3f;
    ...
    iput-object p2, p0, Ldka;->i:Lqgb;

    iput-object p3, p0, Ldka;->j:Lz25;

    iput-object p4, p0, Ldka;->l:Ly9e;

    iput-object p5, p0, Ldka;->k:Laca;

    iput-object p6, p0, Ldka;->m:Lq95;

    iput-object p9, p0, Ldka;->n:Lcka;

    iput-object p10, p0, Ldka;->o:Lcl7;
...
.method public final a(Ljava/lang/CharSequence;ZZZZLjava/util/List;Z)Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v6, v1, Ldka;->g:Ljava/lang/String;
    ...
    iget-object v7, v1, Ldka;->a:Landroid/content/Context;

    sget v8, Ldac;->app_scheme:I
    ...
    iput-object v6, v1, Ldka;->g:Ljava/lang/String;

    :cond_1
    iget-object v6, v1, Ldka;->h:Ljava/util/regex/Pattern;
    ...
    iget-object v7, v1, Ldka;->g:Ljava/lang/String;
    ...
    iput-object v6, v1, Ldka;->h:Ljava/util/regex/Pattern;

    :cond_2
    sget-object v6, Lq3f;->a:Ljava/util/regex/Pattern;
    ...
    :goto_1
    iget-object v0, v1, Ldka;->k:Laca;

    invoke-virtual {v0, v3}, Laca;->a(Z)I

    move-result v7

    if-eqz p4, :cond_4

    sget-object v0, Lor7;->c:Lor7;

    invoke-static {v6, v0, v2, v7}, Lq3f;->a(Landroid/text/Spannable;Lor7;ZI)V
    ...
    :try_start_1
    invoke-static {v6}, Le54;->I(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4, v9, v0}, Ljtg;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v9, v5, v0}, La24;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v9, v1, Ldka;->h:Ljava/util/regex/Pattern;

    iget-object v12, v1, Ldka;->g:Ljava/lang/String;
    ...
    invoke-virtual {v4, v5, v0}, La24;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v11, v1, Ldka;->m:Lq95;

    invoke-interface {v11, v0}, Lq95;->a(Ljava/lang/Throwable;)V
    ...
    :goto_12
    invoke-virtual {v1, v6, v5, v8, v3}, Ldka;->b(Ljava/lang/CharSequence;Lf09;ZZ)Ljava/lang/CharSequence;
...
.method public final b(Ljava/lang/CharSequence;Lf09;ZZ)Ljava/lang/CharSequence;
    .registers 9

    sget-object v0, Lf09;->g:Ljava/util/EnumSet;

    iget-object v1, p2, Lf09;->c:Le09;
    ...
    iget-object p0, p0, Ldka;->b:Laca;

    invoke-virtual {p0, p4}, Laca;->a(Z)I

    move-result p0

    invoke-direct {p3, p2, p0}, Li09;-><init>(Lf09;I)V
    ...
    invoke-static {p2, p3, p4, p0}, Ljtg;->P(Ljava/lang/String;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final c(Landroid/text/SpannableStringBuilder;ZZI)V
    ...
    invoke-direct {v0, p3, v1}, Lxf3;-><init>(ZI)V
    ...
    invoke-direct {p2, p0, p3, v1, v0}, Lltf;-><init>(Landroid/content/Context;IZLjtf;)V
...
.method public final d(J)Ljava/lang/String;
    ...
    iget-object v0, p0, Ldka;->c:Lh53;

    invoke-virtual {v0}, Lgad;->l()J

    move-result-wide v1

    invoke-static {p1, p2, v1, v2}, Ljk7;->H(JJ)Lf11;
    ...
    invoke-static {p2, v1, v2, p0}, Ljk7;->I(Ljava/util/Locale;JZ)Ljava/lang/String;
    ...
    :pswitch_1
    sget p1, Lj9c;->tt_dates_months_past:I

    long-to-int p2, v1

    invoke-static {p1, p2, p0}, Lo3f;->p(IILandroid/content/Context;)Ljava/lang/String;
    ...
    :pswitch_2
    sget p1, Lj9c;->tt_dates_weeks_past:I
    ...
    :pswitch_3
    sget p1, Lj9c;->tt_dates_days_past:I
    ...
    :pswitch_4
    sget p1, Ljcc;->tt_dates_yesterday_at:I

    invoke-virtual {p0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, v1, v2, p2}, Ljk7;->D(Landroid/content/Context;JLjava/util/Locale;)Ljava/lang/String;
    ...
    :pswitch_5
    sget p1, Lj9c;->tt_dates_hours_past:I
    ...
    :pswitch_6
    sget p1, Lj9c;->tt_dates_minutes_past:I
    ...
    :pswitch_7
    sget p1, Ljcc;->tt_dates_right_now:I
...
.method public final f()I
    ...
    invoke-virtual {v1, v3, v2}, Lfl7;->getFloat(Ljava/lang/String;F)F

    move-result v1

    invoke-static {v1}, Lvo4;->e(F)F
...
.method public final h(Ljava/lang/CharSequence;)Lbgb;
    .registers 3
    ...
    invoke-static {p1, p0}, Lp3f;->d(Ljava/lang/String;Ldka;)[Ljava/lang/String;

    move-result-object p0

    new-instance p1, Lbgb;

    invoke-direct {p1, v0, p0}, Lbgb;-><init>(Ljava/lang/CharSequence;[Ljava/lang/String;)V

    return-object p1
.end method

.method public final i(Ljava/lang/String;Ljava/util/ArrayList;)Lbgb;
    .registers 4
    ...
    invoke-virtual {p0, p1}, Ldka;->h(Ljava/lang/CharSequence;)Lbgb;
    ...
    invoke-virtual {p0, p1, p2, v0}, Ldka;->j(Ljava/lang/CharSequence;Ljava/util/List;I)Ljava/lang/CharSequence;
    ...
    invoke-direct {p1, p2, p0}, Lbgb;-><init>(Ljava/lang/CharSequence;[Ljava/lang/String;)V
...
.method public final j(Ljava/lang/CharSequence;Ljava/util/List;I)Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Ldka;->j:Lz25;

    if-nez v0, :cond_1

    invoke-interface {v1, p3, p1}, Lz25;->b(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public final l(Ljava/lang/CharSequence;Ljava/util/List;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v5}, Ldka;->k(Ljava/lang/CharSequence;Ljava/util/List;ZIZ)Ljava/lang/CharSequence;
    ...
    sget-object v2, Le09;->a:Le09;

    if-ne v1, v2, :cond_1

    const/4 v1, 0x0

    invoke-virtual {v0, p1, p2, v1, v3}, Ldka;->b(Ljava/lang/CharSequence;Lf09;ZZ)Ljava/lang/CharSequence;
