...
.method public final a(I)V
    ...
    iget-object v2, v0, Lby4;->X:Ljava/lang/Object;
    ...
    :goto_0
    invoke-static {v13, v8}, Li4h;->p(Ljava/lang/String;Z)V
    ...
    invoke-static {v12, v8}, Li4h;->p(Ljava/lang/String;Z)V

    iput-object v6, v2, Lpz4;->o:Landroid/opengl/EGLDisplay;

    new-array v8, v15, [Landroid/opengl/EGLConfig;

    new-array v12, v15, [I

    sget-object v24, Lpz4;->s0:[I
    ...
    invoke-static {v6, v8}, Li4h;->p(Ljava/lang/String;Z)V

    aget-object v6, v26, v14

    iget-object v8, v2, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :goto_3
    invoke-static {v9, v11}, Li4h;->p(Ljava/lang/String;Z)V

    iput-object v8, v2, Lpz4;->X:Landroid/opengl/EGLContext;

    iget-object v9, v2, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :goto_5
    invoke-static {v4, v6}, Li4h;->p(Ljava/lang/String;Z)V
    ...
    invoke-static {v3, v5}, Li4h;->p(Ljava/lang/String;Z)V

    iput-object v4, v2, Lpz4;->Y:Landroid/opengl/EGLSurface;
    ...
    iput-object v3, v2, Lpz4;->Z:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, v0, Lby4;->X:Ljava/lang/Object;

    check-cast v3, Lpz4;

    iget-object v3, v3, Lpz4;->Z:Landroid/graphics/SurfaceTexture;
    ...
    :cond_7
    invoke-direct {v2, v0, v3, v14}, Lobb;-><init>(Lby4;Landroid/graphics/SurfaceTexture;Z)V

    iput-object v2, v0, Lby4;->Y:Landroid/view/Surface;
    ...
    iput-object v8, v2, Lpz4;->o:Landroid/opengl/EGLDisplay;

    new-array v10, v15, [Landroid/opengl/EGLConfig;

    new-array v12, v15, [I

    sget-object v24, Lpz4;->r0:[I
    ...
    :cond_b
    invoke-direct {v2, v0, v3, v14}, Lcy4;-><init>(Lby4;Landroid/graphics/SurfaceTexture;Z)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lby4;->X:Ljava/lang/Object;

    check-cast v0, Lpz4;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Lby4;->X:Ljava/lang/Object;

    check-cast p0, Lpz4;

    iget-object v0, p0, Lpz4;->b:Landroid/os/Handler;
    ...
    :try_start_0
    iget-object v1, p0, Lpz4;->Z:Landroid/graphics/SurfaceTexture;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/graphics/SurfaceTexture;->release()V

    iget-object v1, p0, Lpz4;->c:[I
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :cond_1
    iget-object v1, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;
    ...
    iget-object v2, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;

    invoke-static {v1, v2}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    :cond_2
    iget-object v1, p0, Lpz4;->X:Landroid/opengl/EGLContext;

    if-eqz v1, :cond_3

    iget-object v2, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :cond_4
    iput-object v0, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;

    iput-object v0, p0, Lpz4;->X:Landroid/opengl/EGLContext;

    iput-object v0, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;

    iput-object v0, p0, Lpz4;->Z:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;

    invoke-static {v2, v3}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    :cond_6
    iget-object v2, p0, Lpz4;->X:Landroid/opengl/EGLContext;

    if-eqz v2, :cond_7

    iget-object v3, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :try_start_1
    iget-object v2, p0, Lpz4;->Z:Landroid/graphics/SurfaceTexture;

    if-eqz v2, :cond_9

    invoke-virtual {v2}, Landroid/graphics/SurfaceTexture;->release()V

    iget-object v2, p0, Lpz4;->c:[I
    ...
    :cond_d
    iget-object v0, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;
    ...
    :cond_e
    iput-object v1, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;

    iput-object v1, p0, Lpz4;->X:Landroid/opengl/EGLContext;

    iput-object v1, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lpz4;->Z:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v4, p0, Lpz4;->Y:Landroid/opengl/EGLSurface;

    invoke-static {v3, v4}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    :cond_10
    iget-object v3, p0, Lpz4;->X:Landroid/opengl/EGLContext;

    if-eqz v3, :cond_11

    iget-object v4, p0, Lpz4;->o:Landroid/opengl/EGLDisplay;
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {p0, p1}, Lby4;->a(I)V
    :try_end_2
    ...
    iput-object p1, p0, Lby4;->c:Ljava/lang/Error;
    :try_end_4
    ...
    iput-object v0, p0, Lby4;->o:Ljava/lang/RuntimeException;
    :try_end_6
    ...
    iput-object p1, p0, Lby4;->o:Ljava/lang/RuntimeException;
    :try_end_8
