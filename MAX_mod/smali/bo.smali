...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Lbo;->u0:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-static {p0, v1}, Lm4f;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v1, Lwdc;->Spinner:[I

    invoke-static {p1, p2, v1, v0}, Lktb;->q(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lktb;
    ...
    invoke-direct {v3, p0}, Lu8;-><init>(Landroid/view/View;)V

    iput-object v3, p0, Lbo;->a:Lu8;

    sget v3, Lwdc;->Spinner_popupTheme:I
    ...
    invoke-direct {v5, p1, v3}, Lfx3;-><init>(Landroid/content/Context;I)V
    ...
    iget-object v6, p0, Lbo;->b:Landroid/content/Context;

    invoke-direct {v3, p0, v6, p2, v0}, Lyn;-><init>(Lbo;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v6, p0, Lbo;->b:Landroid/content/Context;

    sget-object v7, Lwdc;->Spinner:[I

    invoke-static {v6, p2, v7, v0}, Lktb;->q(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lktb;

    move-result-object v6

    sget v7, Lwdc;->Spinner_android_dropDownWidth:I

    iget-object v8, v6, Lktb;->c:Ljava/lang/Object;
    ...
    sget v7, Lwdc;->Spinner_android_popupBackground:I

    invoke-virtual {v6, v7}, Lktb;->j(I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    invoke-virtual {v3, v7}, Lbt7;->i(Landroid/graphics/drawable/Drawable;)V

    sget v7, Lwdc;->Spinner_android_prompt:I

    invoke-virtual {v2, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v3, Lyn;->K0:Ljava/lang/CharSequence;

    invoke-virtual {v6}, Lktb;->t()V

    iput-object v3, p0, Lbo;->s0:Lao;

    new-instance v6, Lrn;

    invoke-direct {v6, p0, p0, v3}, Lrn;-><init>(Lbo;Lbo;Lyn;)V

    iput-object v6, p0, Lbo;->c:Lrn;
    ...
    invoke-direct {v3, p0}, Lun;-><init>(Lbo;)V

    iput-object v3, p0, Lbo;->s0:Lao;

    sget v6, Lwdc;->Spinner_android_prompt:I

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v3, Lun;->c:Ljava/lang/CharSequence;

    :goto_5
    sget v3, Lwdc;->Spinner_android_entries:I
    ...
    sget p1, Lb9c;->support_simple_spinner_dropdown_item:I
    ...
    :cond_7
    iget-object p0, p0, Lbo;->a:Lu8;

    invoke-virtual {p0, p2, v0}, Lu8;->G(Landroid/util/AttributeSet;I)V
...
.method public final a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object p0, p0, Lbo;->u0:Landroid/graphics/Rect;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lao;->f()Ljava/lang/CharSequence;
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lao;->k(I)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lao;->h(Ljava/lang/CharSequence;)V
