...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lrfc;->X:Landroid/content/Context;
...
.method public final G(Ln74;)J
    ...
    iput-object v1, v0, Lrfc;->Y:Ln74;

    invoke-virtual/range {p0 .. p1}, Lii0;->c(Ln74;)V

    iget-object v2, v1, Ln74;->a:Landroid/net/Uri;

    iget-wide v3, v1, Ln74;->g:J

    iget-wide v5, v1, Ln74;->f:J
    ...
    iget-object v10, v0, Lrfc;->X:Landroid/content/Context;
    ...
    invoke-static {v15, v8, v7}, Lsq3;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v7, v0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    iget-object v9, v0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v0, Lrfc;->r0:Ljava/io/FileInputStream;
    ...
    :cond_7
    :goto_5
    iget-object v11, v0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    :goto_7
    iput-wide v5, v0, Lrfc;->s0:J

    :cond_c
    const/4 v11, 0x1

    iput-boolean v11, v0, Lrfc;->t0:Z
    ...
    invoke-static {v2, v1}, Lz7e;->p(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v3, p0, Lrfc;->r0:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lrfc;->r0:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Lrfc;->t0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Lrfc;->t0:Z
    ...
    :try_start_4
    iget-object v4, p0, Lrfc;->Z:Landroid/content/res/AssetFileDescriptor;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Lrfc;->r0:Ljava/io/FileInputStream;
