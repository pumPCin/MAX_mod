...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lohb;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Lohb;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lohb;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object p0, p0, Lohb;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lohb;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Lldf;->c(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    :goto_0
    sget-object v6, Lrhb;->o:Lrhb;

    if-eq v3, v6, :cond_5

    sget-object v6, Lrhb;->c:Lrhb;

    if-eq v3, v6, :cond_5

    sget-object v6, Lrhb;->X:Lrhb;
    ...
    iget-object v0, p0, Lohb;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, Lldf;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lohb;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lohb;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lohb;->c:I

    invoke-static {p2}, Lldf;->b(I)Z
    ...
    iget-object p2, p0, Lohb;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lohb;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lohb;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, p0, v1}, Lldf;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lohb;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lohb;->b:Landroid/graphics/Rect;
