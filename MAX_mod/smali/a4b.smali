...
.method static constructor <clinit>()V
    ...
    sput-object v4, La4b;->h:Ljava/util/logging/Logger;
    ...
    sput-object v5, La4b;->j:Ljava/util/Map;
    ...
    sput-object v6, La4b;->k:Ljava/util/Map;
    ...
    sput-object v6, La4b;->i:Ljava/util/Map;
    ...
    sget-object v1, La4b;->j:Ljava/util/Map;
    ...
    sput-object v1, La4b;->l:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->m:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->n:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->o:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->p:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->q:Ljava/util/regex/Pattern;
    ...
    sput-object v1, La4b;->r:Ljava/util/regex/Pattern;
    ...
    invoke-static {v2}, La4b;->a(Z)Ljava/lang/String;

    move-result-object v2

    const/4 v3, 0x0

    invoke-static {v3}, La4b;->a(Z)Ljava/lang/String;
    ...
    sput-object v3, La4b;->s:Ljava/util/regex/Pattern;
    ...
    invoke-static {v4, v3, v5, v3, v6}, Lz7e;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v4, v0, v5, v3, v6}, Lz7e;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, La4b;->t:Ljava/util/regex/Pattern;
    ...
    sput-object v0, La4b;->u:Ljava/util/regex/Pattern;
    ...
    sput-object v0, La4b;->v:Ljava/util/regex/Pattern;
    ...
    sput-object v0, La4b;->w:Ljava/util/regex/Pattern;
    ...
    sput-object v0, La4b;->x:Ljava/util/regex/Pattern;

    return-void
.end method

.method public constructor <init>(Lbh8;Ljava/util/HashMap;)V
    .registers 8
    ...
    iput-object v0, p0, La4b;->d:Ljava/util/HashSet;
    ...
    iput-object v0, p0, La4b;->f:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, La4b;->g:Ljava/util/HashSet;

    iput-object p1, p0, La4b;->a:Lbh8;

    iput-object p2, p0, La4b;->b:Ljava/util/HashMap;
    ...
    iget-object v1, p0, La4b;->g:Ljava/util/HashSet;
    ...
    :cond_0
    iget-object v0, p0, La4b;->f:Ljava/util/HashSet;
    ...
    :cond_1
    iget-object p1, p0, La4b;->f:Ljava/util/HashSet;
    ...
    :cond_2
    iget-object p0, p0, La4b;->d:Ljava/util/HashSet;
...
.method public static a(Z)Ljava/lang/String;
    ...
    invoke-static {v1}, La4b;->b(I)Ljava/lang/String;
    ...
    invoke-static {v4}, La4b;->b(I)Ljava/lang/String;
    ...
    invoke-static {v6}, La4b;->b(I)Ljava/lang/String;
    ...
    invoke-static {v6, v0, v5}, Lyv7;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, La4b;->b(I)Ljava/lang/String;
...
.method public static h(Lr4b;)Ljava/lang/String;
    .registers 4
    ...
    iget-boolean v1, p0, Lr4b;->Y:Z

    if-eqz v1, :cond_0

    iget v1, p0, Lr4b;->r0:I
...
.method public static i(Lp4b;I)Lq4b;
    .registers 2
    ...
    iget-object p0, p0, Lp4b;->b:Lq4b;

    return-object p0

    :pswitch_0
    iget-object p0, p0, Lp4b;->H0:Lq4b;

    return-object p0

    :pswitch_1
    iget-object p0, p0, Lp4b;->D0:Lq4b;

    return-object p0

    :pswitch_2
    iget-object p0, p0, Lp4b;->B0:Lq4b;

    return-object p0

    :pswitch_3
    iget-object p0, p0, Lp4b;->x0:Lq4b;

    return-object p0

    :pswitch_4
    iget-object p0, p0, Lp4b;->z0:Lq4b;

    return-object p0

    :pswitch_5
    iget-object p0, p0, Lp4b;->v0:Lq4b;

    return-object p0

    :pswitch_6
    iget-object p0, p0, Lp4b;->t0:Lq4b;

    return-object p0

    :pswitch_7
    iget-object p0, p0, Lp4b;->r0:Lq4b;

    return-object p0

    :pswitch_8
    iget-object p0, p0, Lp4b;->Y:Lq4b;

    return-object p0

    :pswitch_9
    iget-object p0, p0, Lp4b;->o:Lq4b;
...
.method public static q(Ljava/lang/StringBuilder;)V
    ...
    sget-object v0, La4b;->r:Ljava/util/regex/Pattern;
    ...
    sget-object v2, La4b;->k:Ljava/util/Map;

    invoke-static {p0, v2}, La4b;->s(Ljava/lang/CharSequence;Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0}, La4b;->r(Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static v(Ljava/lang/StringBuilder;Lp4b;I)I
    .registers 11

    invoke-static {p1, p2}, La4b;->i(Lp4b;I)Lq4b;

    move-result-object v0

    iget-object v1, v0, Lq4b;->c:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Lp4b;->b:Lq4b;

    iget-object v1, v1, Lq4b;->c:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v0, v0, Lq4b;->o:Ljava/util/ArrayList;
    ...
    invoke-static {p1, v4}, La4b;->i(Lp4b;I)Lq4b;

    move-result-object p2

    iget-object v2, p2, Lq4b;->c:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lq4b;->c:Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-static {p0, p1, v6}, La4b;->v(Ljava/lang/StringBuilder;Lp4b;I)I
    ...
    :cond_2
    :goto_1
    invoke-static {p1, v6}, La4b;->i(Lp4b;I)Lq4b;
    ...
    :goto_3
    iget-object v7, p2, Lq4b;->o:Ljava/util/ArrayList;
    ...
    iget-object v1, p2, Lq4b;->c:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lp4b;->b:Lq4b;

    iget-object p1, p1, Lq4b;->c:Ljava/util/ArrayList;

    goto :goto_4

    :cond_5
    iget-object p1, p2, Lq4b;->c:Ljava/util/ArrayList;
...
.method public final c(Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;)I
    ...
    iget-object v4, p0, La4b;->b:Ljava/util/HashMap;
...
.method public final d(Lr4b;I)Ljava/lang/String;
    .registers 13
    ...
    invoke-static {p1}, La4b;->h(Lr4b;)Ljava/lang/String;
    ...
    invoke-static {v1, v3, v0}, La4b;->u(IILjava/lang/StringBuilder;)V

    goto/16 :goto_7

    :cond_0
    iget-object v3, p0, La4b;->b:Ljava/util/HashMap;
    ...
    :cond_1
    invoke-virtual {p0, v1}, La4b;->k(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, La4b;->f(I)Lp4b;
    ...
    :cond_2
    invoke-virtual {p0, v3}, La4b;->g(Ljava/lang/String;)Lp4b;

    move-result-object v3

    :goto_0
    iget-object v4, v3, Lp4b;->h1:Ljava/util/ArrayList;
    ...
    :cond_4
    :goto_1
    iget-object v4, v3, Lp4b;->g1:Ljava/util/ArrayList;
    ...
    iget-object v8, v6, Ln4b;->c:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Ln4b;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v8}, Ltgd;->h(Ljava/lang/String;)Ljava/util/regex/Pattern;
    ...
    :cond_6
    iget-object v8, v6, Ln4b;->a:Ljava/lang/String;
    ...
    :cond_8
    iget-object v4, v6, Ln4b;->b:Ljava/lang/String;
    ...
    iget-object v6, v6, Ln4b;->X:Ljava/lang/String;
    ...
    sget-object v5, La4b;->w:Ljava/util/regex/Pattern;
    ...
    sget-object v4, La4b;->m:Ljava/util/regex/Pattern;
    ...
    iget-boolean v2, p1, Lr4b;->c:Z

    if-eqz v2, :cond_e

    iget-object v2, p1, Lr4b;->o:Ljava/lang/String;
    ...
    iget-object p0, p1, Lr4b;->o:Ljava/lang/String;
    ...
    :cond_c
    iget-boolean p0, v3, Lp4b;->Z0:Z

    if-eqz p0, :cond_d

    iget-object p0, v3, Lp4b;->a1:Ljava/lang/String;
    ...
    :cond_e
    :goto_6
    invoke-static {v1, p2, v0}, La4b;->u(IILjava/lang/StringBuilder;)V
...
.method public final e(Ljava/lang/String;)Lr4b;
    .registers 6
    ...
    sget-object v2, La4b;->h:Ljava/util/logging/Logger;
    ...
    invoke-static {v0, v3}, La4b;->i(Lp4b;I)Lq4b;

    move-result-object v0

    :try_start_0
    iget-boolean v3, v0, Lq4b;->X:Z

    if-eqz v3, :cond_1

    iget-object v0, v0, Lq4b;->Y:Ljava/lang/String;

    invoke-virtual {p0, v0, p1}, La4b;->t(Ljava/lang/String;Ljava/lang/String;)Lr4b;
...
.method public final f(I)Lp4b;
    .registers 4

    iget-object v0, p0, La4b;->g:Ljava/util/HashSet;
    ...
    invoke-virtual {p0, v1}, Lql9;->a(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lbkd;->q(Ljava/lang/String;)Lcf9;

    move-result-object p0

    check-cast p0, Lie3;

    iget-object p0, p0, Lie3;->a:Lim4;
...
.method public final g(Ljava/lang/String;)Lp4b;
    ...
    invoke-virtual {p0, p1}, Lql9;->a(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final j(Ljava/lang/String;Lp4b;)I
    .registers 4

    iget-object v0, p2, Lp4b;->b:Lq4b;

    invoke-virtual {p0, p1, v0}, La4b;->l(Ljava/lang/String;Lq4b;)Z
    ...
    :cond_0
    iget-object v0, p2, Lp4b;->t0:Lq4b;
    ...
    :cond_1
    iget-object v0, p2, Lp4b;->r0:Lq4b;
    ...
    :cond_2
    iget-object v0, p2, Lp4b;->v0:Lq4b;
    ...
    :cond_3
    iget-object v0, p2, Lp4b;->z0:Lq4b;
    ...
    :cond_4
    iget-object v0, p2, Lp4b;->x0:Lq4b;
    ...
    :cond_5
    iget-object v0, p2, Lp4b;->B0:Lq4b;
    ...
    :cond_6
    iget-object v0, p2, Lp4b;->D0:Lq4b;
    ...
    :cond_7
    iget-object v0, p2, Lp4b;->H0:Lq4b;
    ...
    :cond_9
    iget-object p2, p2, Lp4b;->Y:Lq4b;

    invoke-virtual {p0, p1, p2}, La4b;->l(Ljava/lang/String;Lq4b;)Z
...
.method public final k(I)Ljava/lang/String;
    ...
    iget-object p0, p0, La4b;->b:Ljava/util/HashMap;
...
.method public final l(Ljava/lang/String;Lq4b;)Z
    .registers 6
    ...
    :cond_0
    iget-object p0, p0, La4b;->c:Lkga;

    invoke-virtual {p0, p1, p2}, Lkga;->j(Ljava/lang/CharSequence;Lq4b;)Z
...
.method public final m(Lr4b;)Z
    .registers 11

    iget v0, p1, Lr4b;->a:I

    iget-object v1, p0, La4b;->b:Ljava/util/HashMap;
    ...
    sget-object v6, La4b;->h:Ljava/util/logging/Logger;
    ...
    invoke-virtual {p0, v6}, La4b;->g(Ljava/lang/String;)Lp4b;

    move-result-object v7

    iget-boolean v8, v7, Lp4b;->j1:Z

    if-eqz v8, :cond_3

    iget-object v8, p0, La4b;->e:Ltgd;

    iget-object v7, v7, Lp4b;->k1:Ljava/lang/String;

    invoke-virtual {v8, v7}, Ltgd;->h(Ljava/lang/String;)Ljava/util/regex/Pattern;
    ...
    :cond_3
    invoke-virtual {p0, v0, v7}, La4b;->j(Ljava/lang/String;Lp4b;)I
    ...
    invoke-virtual {p0, v0}, La4b;->f(I)Lp4b;
    ...
    :cond_5
    invoke-virtual {p0, v5}, La4b;->g(Ljava/lang/String;)Lp4b;
    ...
    invoke-virtual {p0, p1, v6}, La4b;->j(Ljava/lang/String;Lp4b;)I
...
.method public final n(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, La4b;->f:Ljava/util/HashSet;
...
.method public final o(Ljava/lang/CharSequence;Lp4b;Ljava/lang/StringBuilder;Lr4b;)I
    .registers 10
    ...
    iget-object p1, p2, Lp4b;->U0:Ljava/lang/String;
    ...
    :cond_2
    sget-object v2, La4b;->l:Ljava/util/regex/Pattern;
    ...
    invoke-static {v0}, La4b;->q(Ljava/lang/StringBuilder;)V

    goto :goto_1

    :cond_3
    iget-object v2, p0, La4b;->e:Ltgd;

    invoke-virtual {v2, p1}, Ltgd;->h(Ljava/lang/String;)Ljava/util/regex/Pattern;
    ...
    sget-object v2, La4b;->n:Ljava/util/regex/Pattern;
    ...
    invoke-static {v2}, La4b;->r(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p3}, La4b;->c(Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;)I
    ...
    iget-object v2, p2, Lp4b;->b:Lq4b;

    const/4 v3, 0x0

    invoke-virtual {p0, v4, p2, v3}, La4b;->p(Ljava/lang/StringBuilder;Lp4b;Ljava/lang/StringBuilder;)V

    iget-object p0, p0, La4b;->c:Lkga;

    invoke-virtual {p0, v0, v2}, Lkga;->j(Ljava/lang/CharSequence;Lq4b;)Z

    move-result v3

    if-nez v3, :cond_8

    invoke-virtual {p0, v4, v2}, Lkga;->j(Ljava/lang/CharSequence;Lq4b;)Z
    ...
    invoke-static {v0, p2, p0}, La4b;->v(Ljava/lang/StringBuilder;Lp4b;I)I
...
.method public final p(Ljava/lang/StringBuilder;Lp4b;Ljava/lang/StringBuilder;)V
    .registers 12
    ...
    iget-object v1, p2, Lp4b;->c1:Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Ltgd;->h(Ljava/lang/String;)Ljava/util/regex/Pattern;
    ...
    invoke-virtual {p0, p1, v2}, Lkga;->j(Ljava/lang/CharSequence;Lq4b;)Z
    ...
    iget-object p2, p2, Lp4b;->e1:Ljava/lang/String;
    ...
    invoke-virtual {p0, p2, v2}, Lkga;->j(Ljava/lang/CharSequence;Lq4b;)Z
...
.method public final t(Ljava/lang/String;Ljava/lang/String;)Lr4b;
    .registers 15
    ...
    iput-wide v2, v0, Lr4b;->b:J

    const-string v2, ""

    iput-object v2, v0, Lr4b;->o:Ljava/lang/String;

    iput-boolean v1, v0, Lr4b;->Y:Z

    const/4 v3, 0x1

    iput v3, v0, Lr4b;->r0:I

    iput-object v2, v0, Lr4b;->s0:Ljava/lang/String;

    iput-object v2, v0, Lr4b;->u0:Ljava/lang/String;

    const/4 v4, 0x5

    iput v4, v0, Lr4b;->t0:I
    ...
    sget-object v9, La4b;->s:Ljava/util/regex/Pattern;
    ...
    sget-object v9, La4b;->t:Ljava/util/regex/Pattern;
    ...
    :cond_7
    sget-object v7, La4b;->o:Ljava/util/regex/Pattern;
    ...
    sget-object v7, La4b;->q:Ljava/util/regex/Pattern;
    ...
    :cond_8
    sget-object v7, La4b;->p:Ljava/util/regex/Pattern;
    ...
    sget-object v7, La4b;->v:Ljava/util/regex/Pattern;
    ...
    invoke-virtual {p0, p2}, La4b;->n(Ljava/lang/String;)Z

    move-result p1

    sget-object v8, La4b;->l:Ljava/util/regex/Pattern;
    ...
    :cond_e
    :goto_6
    sget-object p1, La4b;->u:Ljava/util/regex/Pattern;
    ...
    iput-boolean v3, v0, Lr4b;->c:Z

    iput-object v2, v0, Lr4b;->o:Ljava/lang/String;

    :cond_12
    invoke-virtual {p0, p2}, La4b;->g(Ljava/lang/String;)Lp4b;
    ...
    :try_start_0
    invoke-virtual {p0, v6, p1, v2, v0}, La4b;->o(Ljava/lang/CharSequence;Lp4b;Ljava/lang/StringBuilder;Lr4b;)I
    ...
    invoke-virtual {p0, v7, p1, v2, v0}, La4b;->o(Ljava/lang/CharSequence;Lp4b;Ljava/lang/StringBuilder;Lr4b;)I
    ...
    invoke-virtual {p0, v7}, La4b;->k(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, La4b;->f(I)Lp4b;
    ...
    :cond_14
    invoke-static {v6}, La4b;->q(Ljava/lang/StringBuilder;)V

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/CharSequence;)Ljava/lang/StringBuilder;

    if-eqz p2, :cond_15

    iget p2, p1, Lp4b;->T0:I
    ...
    invoke-virtual {p0, v7, p1, p2}, La4b;->p(Ljava/lang/StringBuilder;Lp4b;Ljava/lang/StringBuilder;)V

    const/16 p0, 0xc

    invoke-static {v7, p1, p0}, La4b;->v(Ljava/lang/StringBuilder;Lp4b;I)I
    ...
    iput-boolean v3, v0, Lr4b;->X:Z

    iput-boolean v3, v0, Lr4b;->Y:Z
    ...
    iput-boolean v3, v0, Lr4b;->Z:Z

    iput p0, v0, Lr4b;->r0:I
