...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lgj1;-><init>(J)V
...
.method public constructor <init>(J)V
    ...
    iput-object p1, p0, Lgj1;->u0:Lcl7;

    return-void
.end method

.method public static final o(Lgj1;Landroid/view/View;Z)V
    .registers 5

    instance-of p0, p1, Lgl1;
    ...
    invoke-interface {p0, p2}, Lgl1;->n(Z)V
...
.method public final l(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, p1, p3, p2}, Lgj1;->p(Landroid/animation/AnimatorSet;Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lgj1;->p(Landroid/animation/AnimatorSet;Landroid/view/View;Z)V
...
.method public final p(Landroid/animation/AnimatorSet;Landroid/view/View;Z)V
    ...
    invoke-direct/range {v0 .. v8}, Lfj1;-><init>(Leh;Landroid/view/View;ZLandroid/view/View;ZLandroid/view/View;ZI)V
    ...
    iget-object v0, v1, Lgj1;->u0:Lcl7;
    ...
    iget-object v0, v0, Lra1;->b:Landroid/graphics/PointF;
    ...
    invoke-direct {v0, v3, v8}, Lcg;-><init>(Ljava/lang/String;F)V

    instance-of v11, v2, Lgl1;
    ...
    invoke-direct/range {v0 .. v6}, Lej1;-><init>(Landroid/animation/ObjectAnimator;Lgj1;ZLandroid/view/View;Landroid/graphics/PointF;Lgl1;)V
    ...
    invoke-virtual {v7, v4}, Los7;->add(Ljava/lang/Object;)Z
    ...
    iget-wide v0, v1, Leh;->o:J

    invoke-interface {v12, v7, v3, v0, v1}, Lgl1;->f(Los7;ZJ)V
