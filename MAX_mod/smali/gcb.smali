...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgcb;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    iput-wide p2, p0, Lgcb;->b:J

    iput-wide p4, p0, Lgcb;->c:J

    iput p6, p0, Lgcb;->o:F

    iput-wide p7, p0, Lgcb;->X:J

    iput p9, p0, Lgcb;->Y:I

    iput-object p10, p0, Lgcb;->Z:Ljava/lang/CharSequence;

    iput-wide p11, p0, Lgcb;->r0:J
    ...
    :goto_0
    iput-object p1, p0, Lgcb;->s0:Ljava/util/AbstractCollection;

    move-wide p1, p14

    iput-wide p1, p0, Lgcb;->t0:J

    move-object/from16 p1, p16

    iput-object p1, p0, Lgcb;->u0:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-wide v0, p0, Lgcb;->r0:J

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Lgcb;->c:J
    ...
    iput-object v0, p0, Lgcb;->Z:Ljava/lang/CharSequence;

    sget-object v0, Lfcb;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :cond_0
    iput-object v0, p0, Lgcb;->s0:Ljava/util/AbstractCollection;

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Lgcb;->t0:J
    ...
    iput-object v0, p0, Lgcb;->u0:Landroid/os/Bundle;
...
.method public static a(Landroid/media/session/PlaybackState;)Lgcb;
    .registers 27
    ...
    invoke-static {v4}, Lfo8;->q(Landroid/os/Bundle;)V
    ...
    invoke-direct {v5, v6, v7, v8, v4}, Lfcb;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;)V

    iput-object v3, v5, Lfcb;->X:Landroid/media/session/PlaybackState$CustomAction;
    ...
    invoke-static/range {v25 .. v25}, Lfo8;->q(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v9 .. v25}, Lgcb;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V

    iput-object v0, v9, Lgcb;->v0:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lgcb;->s0:Ljava/util/AbstractCollection;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Lgcb;->Z:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Lgcb;->s0:Ljava/util/AbstractCollection;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    iget-wide v0, p0, Lgcb;->t0:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object p2, p0, Lgcb;->u0:Landroid/os/Bundle;
