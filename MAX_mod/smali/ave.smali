...
.field public final s0:Lbve;

.field public final t0:Ljava/lang/Object;

.field public final u0:Ljava/lang/Object;

.field public final v0:Lnn8;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lave;->C0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lave;->D0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Lgn8;)V
    ...
    iput-object v0, p0, Lave;->A0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lave;->B0:Ljava/util/ArrayList;

    iput-object p2, p0, Lave;->s0:Lbve;
    ...
    iput-object p2, p0, Lave;->t0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lpn8;-><init>(Lave;)V

    iput-object v1, p0, Lave;->u0:Ljava/lang/Object;

    new-instance v0, Lnn8;

    invoke-direct {v0, p0}, Lnn8;-><init>(Lmn8;)V

    iput-object v0, p0, Lave;->v0:Lnn8;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lsbc;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lave;->w0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lave;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Lzue;
    .registers 2
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lave;->n(Ljava/lang/Object;)Lzue;

    move-result-object p0

    if-eqz p0, :cond_0

    iget-object p0, p0, Lzue;->a:Ljn8;

    invoke-virtual {p0, p2}, Ljn8;->j(I)V
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p0, p2}, Ljn8;->k(I)V
...
.method public final d(Ljava/lang/String;)Lzm8;
    ...
    invoke-virtual {p0, p1}, Lave;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object p0, p0, Lave;->A0:Ljava/util/ArrayList;
    ...
    invoke-direct {p1, p0}, Lxue;-><init>(Ljava/lang/Object;)V
...
.method public final f(Lim8;)V
    ...
    iget-object v1, p1, Lim8;->b:Lcn8;

    invoke-virtual {v1}, Lcn8;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lave;->x0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lave;->y0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lave;->x0:I

    iput-boolean p1, p0, Lave;->y0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lave;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lave;->m()Landroid/media/MediaRouter$RouteInfo;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lave;->k(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, Lave;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lyue;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Lay7;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lave;->o(Lyue;Lay7;)V

    invoke-virtual {v4}, Lay7;->n()Lgm8;

    move-result-object p1

    iput-object p1, v3, Lyue;->c:Lgm8;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v2, v2, Lyue;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v2, v2, Lyue;->b:Ljava/lang/String;
...
.method public final l(Ljn8;)I
    .registers 5

    iget-object p0, p0, Lave;->B0:Ljava/util/ArrayList;
...
.method public o(Lyue;Lay7;)V
    .registers 5

    iget-object p0, p2, Lay7;->b:Ljava/lang/Object;

    check-cast p0, Landroid/os/Bundle;

    iget-object p1, p1, Lyue;->a:Ljava/lang/Object;
    ...
    sget-object v1, Lave;->C0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Lay7;->m(Ljava/util/List;)V
    ...
    sget-object v0, Lave;->D0:Ljava/util/ArrayList;

    invoke-virtual {p2, v0}, Lay7;->m(Ljava/util/List;)V
...
.method public final p(Ljn8;)V
    ...
    iget-object v0, p0, Lave;->w0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Lzue;-><init>(Ljn8;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lave;->v0:Lnn8;
    ...
    invoke-virtual {p0, v2}, Lave;->w(Lzue;)V
    ...
    invoke-virtual {p0, v0}, Lave;->j(Ljava/lang/Object;)I
    ...
    iget-object p0, p0, Lyue;->b:Ljava/lang/String;

    iget-object v0, p1, Ljn8;->b:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Ljn8;->l()V

    :cond_1
    return-void
.end method

.method public final q(Ljn8;)V
    .registers 4
    ...
    invoke-virtual {p0, p1}, Lave;->l(Ljn8;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lave;->B0:Ljava/util/ArrayList;
...
.method public final r(Ljn8;)V
    ...
    invoke-virtual {p0, p1}, Lave;->t(Ljava/lang/Object;)V

    return-void

    :cond_1
    iget-object p1, p1, Ljn8;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lave;->A0:Ljava/util/ArrayList;
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lbn8;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0}, Lave;->u()V

    iget-object v0, p0, Lave;->t0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Lave;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lave;->s()V

    :cond_2
    return-void
.end method

.method public w(Lzue;)V
    .registers 4

    iget-object p0, p1, Lzue;->b:Ljava/lang/Object;

    iget-object v0, p1, Lzue;->a:Ljn8;

    iget-object v1, v0, Ljn8;->d:Ljava/lang/String;
