...
# direct methods
.method public static final a(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lxg1;
    .registers 5
    ...
    invoke-static {p0, v0, v1}, Ljme;->D0(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-static {v0}, Lqme;->S(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {v0, v2, v3, v1}, Lxg1;-><init>(JI)V
...
.method public static final c(Lxg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .registers 4

    new-instance v0, Lru/ok/android/externcalls/sdk/id/ParticipantId;

    iget-wide v1, p0, Lxg1;->a:J
