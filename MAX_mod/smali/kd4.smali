...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lx46;Landroid/media/MediaFormat;Ljava/lang/String;ZLandroid/view/Surface;)V
    .registers 16

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lkd4;->c:Lx46;

    iput-object p3, p0, Lkd4;->b:Landroid/media/MediaFormat;

    iput-boolean p5, p0, Lkd4;->g:Z

    iget-object p2, p2, Lx46;->n:Ljava/lang/String;
    ...
    iput-boolean p2, p0, Lkd4;->h:Z

    new-instance v0, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {v0}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object v0, p0, Lkd4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-object v0, p0, Lkd4;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p6, v3}, Lmq0;->b(Ljava/lang/Object;Z)V
    ...
    iput-object v7, p0, Lkd4;->d:Landroid/media/MediaCodec;

    iput-object v6, p0, Lkd4;->e:Landroid/view/Surface;

    invoke-static {p1}, Lnrf;->N(Landroid/content/Context;)Z
    ...
    invoke-static {p1, p2}, Lxnd;->q(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    :goto_7
    iget-boolean p0, p0, Lkd4;->h:Z

    new-instance p6, Lsk3;

    invoke-virtual {p3}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p6, p3, p4, p0, p5}, Lsk3;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, p2, p6}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILsk3;)Landroidx/media3/transformer/ExportException;
...
.method public static a(Landroid/media/MediaFormat;ZLaf9;)Lx46;
    .registers 4

    invoke-static {p0}, Laec;->p(Landroid/media/MediaFormat;)Lx46;
...
.method public final b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :goto_0
    invoke-virtual {p0}, Lkd4;->c()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Lsk3;

    iget-object v4, p0, Lkd4;->b:Landroid/media/MediaFormat;
    ...
    invoke-direct {v3, v4, v2, p0, v0}, Lsk3;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, v1, v3}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILsk3;)Landroidx/media3/transformer/ExportException;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object p0, p0, Lkd4;->d:Landroid/media/MediaCodec;
...
.method public final d()Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v0, p0, Lkd4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object p0, p0, Lkd4;->k:Ljava/nio/ByteBuffer;
...
.method public final f(Lga4;)Z
    .registers 6

    const-string v0, "MediaCodec error"

    iget-object v1, p0, Lkd4;->d:Landroid/media/MediaCodec;

    iget-boolean v2, p0, Lkd4;->n:Z
    ...
    iput-object v1, p1, Lga4;->X:Ljava/nio/ByteBuffer;
    :try_end_1
    ...
    invoke-static {p1, v0}, Lxnd;->q(Ljava/lang/Exception;Ljava/lang/String;)V

    invoke-virtual {p0, p1}, Lkd4;->b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :cond_2
    :goto_1
    iget-object p0, p1, Lga4;->X:Ljava/nio/ByteBuffer;
...
.method public final g(Z)Z
    ...
    iget-object v1, p0, Lkd4;->c:Lx46;

    iget-boolean v2, p0, Lkd4;->g:Z

    iget-object v3, p0, Lkd4;->d:Landroid/media/MediaCodec;

    iget-object v4, p0, Lkd4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v0, v1, Lx46;->l:Laf9;

    invoke-static {p1, v2, v0}, Lkd4;->a(Landroid/media/MediaFormat;ZLaf9;)Lx46;

    move-result-object p1

    iput-object p1, p0, Lkd4;->j:Lx46;

    if-eqz v2, :cond_2

    iget-object p1, v1, Lx46;->n:Ljava/lang/String;
    ...
    iput-object v0, p0, Lkd4;->j:Lx46;

    :cond_2
    if-nez v2, :cond_3

    iget-boolean p1, p0, Lkd4;->h:Z

    if-eqz p1, :cond_3

    iget-object p0, p0, Lkd4;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p1, p0, Lkd4;->k:Ljava/nio/ByteBuffer;
    :try_end_5
...
.method public final h(Lga4;)V
    .registers 11

    iget-boolean v0, p0, Lkd4;->n:Z
    ...
    iget-object v3, p1, Lga4;->X:Ljava/nio/ByteBuffer;
    ...
    iput-object p0, p1, Lga4;->X:Ljava/nio/ByteBuffer;
...
.method public final i()V
    ...
    iput-object v0, p0, Lkd4;->k:Ljava/nio/ByteBuffer;

    iget-object v0, p0, Lkd4;->e:Landroid/view/Surface;
...
.method public final j()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lkd4;->k(JZ)V
...
.method public final k(JZ)V
    ...
    iput-object v1, p0, Lkd4;->k:Ljava/nio/ByteBuffer;
