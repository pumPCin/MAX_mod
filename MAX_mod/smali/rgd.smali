...
.method public constructor <init>(Lhc8;)V
    ...
    sget-object v0, Lm84;->m:Lm84;

    invoke-direct {p0, v0}, Lls7;-><init>(Li4h;)V

    iput-object p1, p0, Lrgd;->X:Lhc8;
...
.method public final r(Lzoc;I)V
    ...
    iget-object p2, p1, Lqgd;->F0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    iget-object v0, p0, Lngd;->r0:Landroid/net/Uri;

    iput-object p0, p1, Lqgd;->H0:Lngd;

    iget-object v1, p1, Lqgd;->I0:Landroid/net/Uri;

    iget-object v2, p0, Lngd;->o:Landroid/net/Uri;
    ...
    iget-object v1, p1, Lqgd;->J0:Landroid/net/Uri;
    ...
    :cond_0
    iput-object v2, p1, Lqgd;->I0:Landroid/net/Uri;

    iput-object v0, p1, Lqgd;->J0:Landroid/net/Uri;

    invoke-static {v2}, Lj27;->d(Landroid/net/Uri;)Lj27;

    move-result-object v1

    iput-boolean v3, v1, Lj27;->h:Z
    ...
    invoke-direct {v2, v4, v0}, Ljwa;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual {p2, v0, v1}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->o(Li27;Li27;)V

    :cond_2
    iget-object p0, p0, Lngd;->a:Lfx7;

    iget-object p0, p0, Lfx7;->v0:Lex7;

    sget-object p2, Lex7;->o:Lex7;
    ...
    :goto_0
    iget-object p0, p1, Lqgd;->G0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final t(Landroid/view/ViewGroup;I)Lzoc;
    ...
    invoke-static {p1, v0}, Llw3;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v3 .. v8}, Lvf1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/graphics/drawable/Drawable;Lkotlin/coroutines/Continuation;I)V
    ...
    invoke-direct/range {v0 .. v5}, Lqgd;-><init>(Lhc8;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/appcompat/widget/AppCompatImageView;Landroid/widget/FrameLayout;)V
