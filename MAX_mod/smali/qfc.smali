...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lqfc;->X:Landroid/content/res/Resources;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lqfc;->Y:Ljava/lang/String;
...
.method public final P(Lm74;)J
    ...
    iget-object v2, v1, Lm74;->a:Landroid/net/Uri;

    iget-wide v3, v1, Lm74;->g:J

    iget-wide v5, v1, Lm74;->f:J

    iput-object v2, v0, Lqfc;->Z:Landroid/net/Uri;
    ...
    iget-object v10, v0, Lqfc;->X:Landroid/content/res/Resources;
    ...
    iget-object v13, v0, Lqfc;->Y:Ljava/lang/String;
    ...
    iput-object v7, v0, Lqfc;->r0:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v0, Lqfc;->s0:Ljava/io/FileInputStream;
    ...
    :goto_6
    iput-wide v5, v0, Lqfc;->t0:J

    :cond_d
    iput-boolean v11, v0, Lqfc;->u0:Z
...
.method public final close()V
    ...
    iput-object v0, p0, Lqfc;->Z:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Lqfc;->s0:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lqfc;->s0:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Lqfc;->r0:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Lqfc;->r0:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Lqfc;->u0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Lqfc;->u0:Z
    ...
    :try_start_4
    iget-object v4, p0, Lqfc;->r0:Landroid/content/res/AssetFileDescriptor;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lqfc;->Z:Landroid/net/Uri;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Lqfc;->s0:Ljava/io/FileInputStream;
