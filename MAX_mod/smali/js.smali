...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljs;->a:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, Ljs;->b:Landroid/util/Rational;
    ...
    sput-object v0, Ljs;->c:Landroid/util/Rational;

    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v1}, Landroid/util/Rational;-><init>(II)V

    sput-object v0, Ljs;->d:Landroid/util/Rational;
...
.method public static a(Landroid/util/Size;Landroid/util/Rational;Landroid/util/Size;)Z
    ...
    invoke-static {v3, p2, p1}, Ljs;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p1, p0, v1}, Ljs;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p0, p2, p1}, Ljs;->b(IILandroid/util/Rational;)Z
    ...
    invoke-static {p2, p0, v1}, Ljs;->b(IILandroid/util/Rational;)Z
