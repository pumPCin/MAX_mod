...
.field public static final o:Ld6d;

.field public static final p:Lc3e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvd5;->n:Landroid/graphics/Rect;

    new-instance v0, Ld6d;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lvd5;->o:Ld6d;

    new-instance v0, Lc3e;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lvd5;->p:Lc3e;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lvd5;->d:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lvd5;->e:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lvd5;->f:Landroid/graphics/Rect;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Lvd5;->g:[I
    ...
    iput-object p1, p0, Lvd5;->i:Landroid/view/View;
    ...
    iput-object v0, p0, Lvd5;->h:Landroid/view/accessibility/AccessibilityManager;
...
.method public final b(Landroid/view/View;)Ly9e;
    ...
    iget-object p1, p0, Lvd5;->j:Lud5;

    if-nez p1, :cond_0

    new-instance p1, Lud5;

    invoke-direct {p1, p0}, Lud5;-><init>(Lvd5;)V

    iput-object p1, p0, Lvd5;->j:Lud5;

    :cond_0
    iget-object p0, p0, Lvd5;->j:Lud5;
...
.method public final d(Landroid/view/View;Lp4;)V
    ...
    invoke-virtual {p0, p2}, Lvd5;->t(Lp4;)V
...
.method public final j(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Lvd5;->v(IZ)V

    const/16 v0, 0x8

    invoke-virtual {p0, p1, v0}, Lvd5;->x(II)V
...
.method public final k(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    iget-object v1, p0, Lvd5;->i:Landroid/view/View;
    ...
    invoke-virtual {p0}, Lp4;->g()Ljava/lang/CharSequence;
...
.method public final l(I)Lp4;
    ...
    invoke-direct {v1, v0}, Lp4;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v1, v3}, Lp4;->h(Ljava/lang/CharSequence;)V

    sget-object v3, Lvd5;->n:Landroid/graphics/Rect;

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInParent(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInScreen(Landroid/graphics/Rect;)V

    iget-object v4, p0, Lvd5;->i:Landroid/view/View;

    invoke-virtual {v0, v4}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, Lvd5;->u(ILp4;)V

    invoke-virtual {v1}, Lp4;->g()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    iget-object v5, p0, Lvd5;->e:Landroid/graphics/Rect;

    invoke-virtual {v1, v5}, Lp4;->f(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, v6}, Lp4;->a(I)V
    ...
    invoke-virtual {v1, v5}, Lp4;->a(I)V
    ...
    invoke-virtual {v1, v2}, Lp4;->a(I)V

    :cond_5
    :goto_3
    invoke-virtual {v0, p1}, Landroid/view/accessibility/AccessibilityNodeInfo;->setFocused(Z)V

    iget-object p1, p0, Lvd5;->g:[I

    invoke-virtual {v4, p1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v5, p0, Lvd5;->d:Landroid/graphics/Rect;
    ...
    :cond_6
    iget-object p0, p0, Lvd5;->f:Landroid/graphics/Rect;
...
.method public final m(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lvd5;->h:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {p0, v5, v3}, Lvd5;->x(II)V

    invoke-virtual {p0, p1, v2}, Lvd5;->x(II)V
    ...
    invoke-virtual {p0, v0, p1}, Lvd5;->n(FF)I
    ...
    invoke-virtual {p0, p1, v3}, Lvd5;->x(II)V

    invoke-virtual {p0, v0, v2}, Lvd5;->x(II)V
...
.method public final p(I)V
    ...
    invoke-virtual {p0, p1, v2}, Lvd5;->k(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public final q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v3}, Lvd5;->o(Ljava/util/ArrayList;)V

    new-instance v4, Lu7e;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lu7e;-><init>(I)V
    ...
    invoke-virtual {v0, v7}, Lvd5;->l(I)Lp4;
    ...
    invoke-virtual {v4, v8, v7}, Lu7e;->c(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v4, v3}, Lu7e;->b(I)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v8, Lvd5;->o:Ld6d;

    sget-object v9, Lvd5;->p:Lc3e;

    iget-object v10, v0, Lvd5;->i:Landroid/view/View;
    ...
    invoke-virtual {v0, v5}, Lvd5;->r(I)Lp4;

    move-result-object v2

    invoke-virtual {v2, v13}, Lp4;->f(Landroid/graphics/Rect;)V
    ...
    iget-object v11, v4, Lu7e;->b:[Ljava/lang/Object;
    ...
    invoke-virtual {v11, v6}, Lp4;->f(Landroid/graphics/Rect;)V

    invoke-static {v1, v13, v6}, Ln4e;->x(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v13, v2}, Ln4e;->x(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v13, v6, v2}, Ln4e;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v13, v2, v6}, Ln4e;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v13, v6}, Ln4e;->B(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v6}, Ln4e;->C(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v13, v2}, Ln4e;->B(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v2}, Ln4e;->C(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    iget-object v12, v4, Lu7e;->b:[Ljava/lang/Object;
    ...
    invoke-direct {v6, v5, v8}, Lsx5;-><init>(ZLd6d;)V
    ...
    iget-object v6, v4, Lu7e;->b:[Ljava/lang/Object;
    ...
    :goto_12
    iget-object v1, v4, Lu7e;->a:[I

    aget v7, v1, v12

    :goto_13
    invoke-virtual {v0, v7}, Lvd5;->w(I)Z
...
.method public final r(I)Lp4;
    ...
    iget-object p1, p0, Lvd5;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Lvd5;->o(Ljava/util/ArrayList;)V
    ...
    iget-object v4, v1, Lp4;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lvd5;->l(I)Lp4;
...
.method public t(Lp4;)V
    .registers 2

    return-void
.end method

.method public abstract u(ILp4;)V
.end method
...
.method public final w(I)Z
    ...
    invoke-virtual {p0, p1, v0}, Lvd5;->v(IZ)V

    const/16 v1, 0x8

    invoke-virtual {p0, p1, v1}, Lvd5;->x(II)V
...
.method public final x(II)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lvd5;->k(II)Landroid/view/accessibility/AccessibilityEvent;
