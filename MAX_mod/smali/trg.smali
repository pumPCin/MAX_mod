...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Ltrg;->c:Ljava/util/List;

    sget-object v1, Ls12;->g:Ls12;

    iput-object v1, p0, Ltrg;->o:Ls12;

    const v1, 0x3d5a511a    # 0.0533f

    iput v1, p0, Ltrg;->r0:F

    const v1, 0x3da3d70a    # 0.08f

    iput v1, p0, Ltrg;->s0:F

    new-instance v1, Lp12;

    const/4 v2, 0x0

    invoke-direct {v1, p1, v2}, Lp12;-><init>(Landroid/content/Context;I)V

    iput-object v1, p0, Ltrg;->a:Lp12;
...
.method public final a(Ljava/util/List;Ls12;FF)V
    ...
    iput-object p2, p0, Ltrg;->o:Ls12;

    iput p3, p0, Ltrg;->r0:F

    iput p4, p0, Ltrg;->s0:F
    ...
    iget-object v4, v3, Ld44;->o:Landroid/graphics/Bitmap;
    ...
    :cond_1
    iget-object p1, p0, Ltrg;->c:Ljava/util/List;
    ...
    :cond_3
    iget-object p1, p0, Ltrg;->a:Lp12;

    invoke-virtual {p1, v0, p2, p3, p4}, Lp12;->a(Ljava/util/List;Ls12;FF)V
...
.method public final b(IF)Ljava/lang/String;
    ...
    invoke-static {p2, p1, v0, v1}, Lf54;->F(FIII)F
...
.method public final c()V
    ...
    iget-object v2, v0, Ltrg;->o:Ls12;

    iget v2, v2, Ls12;->a:I

    invoke-static {v2}, Lya6;->K(I)Ljava/lang/String;

    move-result-object v2

    iget v3, v0, Ltrg;->r0:F

    const/4 v4, 0x0

    invoke-virtual {v0, v4, v3}, Ltrg;->b(IF)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v7}, Lya6;->K(I)Ljava/lang/String;
    ...
    invoke-static {v3}, Lya6;->k(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v6, v0, Ltrg;->o:Ls12;

    iget v6, v6, Ls12;->b:I

    invoke-static {v6}, Lya6;->K(I)Ljava/lang/String;
    ...
    :goto_1
    iget-object v7, v0, Ltrg;->c:Ljava/util/List;
    ...
    iget v13, v7, Ld44;->r0:F

    iget v14, v7, Ld44;->Z:I

    iget v15, v7, Ld44;->z0:I
    ...
    :goto_b
    iget-object v4, v7, Ld44;->b:Landroid/text/Layout$Alignment;
    ...
    :goto_f
    iget v4, v7, Ld44;->x0:I

    iget v12, v7, Ld44;->y0:F

    invoke-virtual {v0, v4, v12}, Ltrg;->b(IF)Ljava/lang/String;

    move-result-object v33

    iget-boolean v4, v7, Ld44;->v0:Z

    if-eqz v4, :cond_15

    iget v4, v7, Ld44;->w0:I

    goto :goto_10

    :cond_15
    iget-object v4, v0, Ltrg;->o:Ls12;

    iget v4, v4, Ls12;->c:I

    :goto_10
    invoke-static {v4}, Lya6;->K(I)Ljava/lang/String;
    ...
    :goto_17
    iget-object v3, v7, Ld44;->a:Ljava/lang/CharSequence;
    ...
    sget-object v10, Lt7e;->a:Ljava/util/regex/Pattern;
    ...
    invoke-direct {v3, v4, v5}, Lpxg;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {v3}, Lt7e;->a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {v5, v3, v4}, Lpxg;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {v4}, Lya6;->k(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v11}, Lya6;->K(I)Ljava/lang/String;
    ...
    invoke-static {v8, v6, v12}, Lyv7;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v6, v11}, Lyv7;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, v8, Lg1d;->a:Ljava/lang/String;

    invoke-static {v8}, Lt7e;->a(Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v8

    const/16 v13, 0x10

    invoke-static {v13, v8}, Lsq3;->f(ILjava/lang/String;)I
    ...
    invoke-direct {v14, v6, v13, v5, v8}, Lr7e;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    :cond_44
    iget-object v6, v6, Ls7e;->a:Ljava/util/ArrayList;
    ...
    :cond_45
    iget-object v5, v6, Ls7e;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Lt7e;->a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    iget-object v14, v6, Ls7e;->b:Ljava/util/ArrayList;

    iget-object v11, v6, Ls7e;->a:Ljava/util/ArrayList;

    move-object/from16 v18, v4

    sget-object v4, Lr7e;->f:Lkj4;

    invoke-static {v14, v4}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    iget-object v4, v6, Ls7e;->b:Ljava/util/ArrayList;
    ...
    iget-object v6, v6, Lr7e;->d:Ljava/lang/String;
    ...
    iget-object v6, v6, Lr7e;->c:Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v11}, Lpxg;-><init>(Ljava/lang/String;I)V

    :goto_2b
    iget-object v3, v3, Lpxg;->b:Ljava/lang/String;
    ...
    iget-object v4, v7, Ld44;->c:Landroid/text/Layout$Alignment;

    if-eqz v4, :cond_53

    sget-object v5, Lsrg;->a:[I
