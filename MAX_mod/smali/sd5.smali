...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lsd5;->b:Ljava/lang/CharSequence;

    sget-object p1, Lclf;->I:Lv2f;

    new-instance v0, Lak;

    const/16 v1, 0x8

    invoke-direct {v0, v1, p0, p1}, Lak;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lsd5;->c:Lak;
    ...
    invoke-virtual {p0}, Lsd5;->getTypography()Lv2f;
    ...
    iput-object p1, p0, Lsd5;->o:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lsd5;->s0:I

    invoke-virtual {v0, p0}, Lbx9;->l(Landroid/view/View;)Lera;

    move-result-object p1

    invoke-virtual {p0, p1}, Lsd5;->onThemeChanged(Lera;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lsh9;->b(Ljava/lang/CharSequence;)Lq7e;
    ...
    iget-object v1, p0, Lsd5;->a:Lzk7;

    iget-object v3, p0, Lsd5;->o:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lsd5;->r0:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lsd5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lsd5;->v0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lsd5;->s0:I
    ...
    iget-object v3, p0, Lsd5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lsd5;->o:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Ljme;->J0(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lr87;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Le54;->I(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lsd5;->u0:Landroid/text/Layout;
...
.method public final c()V
    ...
    :cond_0
    iget-object v0, p0, Lsd5;->A0:Lrp0;
    ...
    iget-object p0, p0, Lsd5;->A0:Lrp0;
...
.method public final getText()Landroid/text/SpannableString;
    ...
    iget-object p0, p0, Lsd5;->r0:Landroid/text/SpannableString;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object p0, p0, Lsd5;->t0:Landroid/text/Layout;

    return-object p0
.end method

.method public final getTypography()Lv2f;
    .registers 3

    sget-object v0, Lsd5;->B0:[Lxi7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Lsd5;->c:Lak;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lsd5;->z0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lsd5;->t0:Landroid/text/Layout;
...
.method public final onThemeChanged(Lera;)V
    ...
    iget-object v0, p0, Lsd5;->o:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lsd5;->r0:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Lsd5;->t0:Landroid/text/Layout;
    ...
    :cond_1
    iget-object v1, p0, Lsd5;->t0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lsq3;->b(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    iput-object p1, p0, Lsd5;->r0:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lsh9;->e(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    invoke-static {p1}, Lsh9;->b(Ljava/lang/CharSequence;)Lq7e;
