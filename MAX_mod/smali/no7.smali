...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, p0, Lno7;->mBaselineAligned:Z

    const/4 v1, -0x1

    iput v1, p0, Lno7;->mBaselineAlignedChildIndex:I

    const/4 v2, 0x0

    iput v2, p0, Lno7;->mBaselineChildTop:I

    const v3, 0x800033

    iput v3, p0, Lno7;->mGravity:I

    sget-object v3, Lwdc;->LinearLayoutCompat:[I

    invoke-static {p1, p2, v3, p3}, Lktb;->q(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lktb;

    move-result-object v3

    sget-object v6, Lwdc;->LinearLayoutCompat:[I

    iget-object v4, v3, Lktb;->c:Ljava/lang/Object;
    ...
    sget p0, Lwdc;->LinearLayoutCompat_android_orientation:I

    iget-object p1, v3, Lktb;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v4, p0}, Lno7;->setOrientation(I)V

    :cond_0
    sget p0, Lwdc;->LinearLayoutCompat_android_gravity:I
    ...
    invoke-virtual {v4, p0}, Lno7;->setGravity(I)V

    :cond_1
    sget p0, Lwdc;->LinearLayoutCompat_android_baselineAligned:I
    ...
    invoke-virtual {v4, p0}, Lno7;->setBaselineAligned(Z)V

    :cond_2
    sget p0, Lwdc;->LinearLayoutCompat_android_weightSum:I
    ...
    iput p0, v4, Lno7;->mWeightSum:F

    sget p0, Lwdc;->LinearLayoutCompat_android_baselineAlignedChildIndex:I

    invoke-virtual {p1, p0, v1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    iput p0, v4, Lno7;->mBaselineAlignedChildIndex:I

    sget p0, Lwdc;->LinearLayoutCompat_measureWithLargestChild:I

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v4, Lno7;->mUseLargestChild:Z

    sget p0, Lwdc;->LinearLayoutCompat_divider:I

    invoke-virtual {v3, p0}, Lktb;->j(I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    invoke-virtual {v4, p0}, Lno7;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    sget p0, Lwdc;->LinearLayoutCompat_showDividers:I

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    iput p0, v4, Lno7;->mShowDividers:I

    sget p0, Lwdc;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v4, Lno7;->mDividerPadding:I

    invoke-virtual {v3}, Lktb;->t()V
...
.method public drawDividersHorizontal(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lno7;->getVirtualChildCount()I
    ...
    invoke-virtual {p0, v2}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Lno7;->hasDividerBeforeChildAt(I)Z
    ...
    iget v5, p0, Lno7;->mDividerWidth:I

    sub-int/2addr v4, v5

    :goto_1
    invoke-virtual {p0, p1, v4}, Lno7;->drawVerticalDivider(Landroid/graphics/Canvas;I)V
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lno7;->hasDividerBeforeChildAt(I)Z
    ...
    invoke-virtual {p0, v0}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    iget v1, p0, Lno7;->mDividerWidth:I
    ...
    :goto_3
    invoke-virtual {p0, p1, v0}, Lno7;->drawVerticalDivider(Landroid/graphics/Canvas;I)V
...
.method public drawDividersVertical(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, v1}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lno7;->hasDividerBeforeChildAt(I)Z
    ...
    iget v3, p0, Lno7;->mDividerHeight:I

    sub-int/2addr v2, v3

    invoke-virtual {p0, p1, v2}, Lno7;->drawHorizontalDivider(Landroid/graphics/Canvas;I)V
    ...
    iget v1, p0, Lno7;->mDividerHeight:I
    ...
    :goto_1
    invoke-virtual {p0, p1, v0}, Lno7;->drawHorizontalDivider(Landroid/graphics/Canvas;I)V
...
.method public drawHorizontalDivider(Landroid/graphics/Canvas;I)V
    ...
    iget-object v0, p0, Lno7;->mDivider:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/view/View;->getPaddingLeft()I

    move-result v1

    iget v2, p0, Lno7;->mDividerPadding:I
    ...
    iget v3, p0, Lno7;->mDividerPadding:I
    ...
    iget-object p0, p0, Lno7;->mDivider:Landroid/graphics/drawable/Drawable;
...
.method public drawVerticalDivider(Landroid/graphics/Canvas;I)V
    ...
    iget v2, p0, Lno7;->mDividerWidth:I
    ...
    iget v4, p0, Lno7;->mDividerPadding:I
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Lno7;->generateDefaultLayoutParams()Lmo7;
...
.method public generateDefaultLayoutParams()Lmo7;
    .registers 3

    iget p0, p0, Lno7;->mOrientation:I
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Lno7;->generateLayoutParams(Landroid/util/AttributeSet;)Lmo7;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Lno7;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Lmo7;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Lmo7;
    .registers 3
...
.method public generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Lmo7;
    .registers 2
...
.method public getBaseline()I
    ...
    iget v0, p0, Lno7;->mBaselineAlignedChildIndex:I
    ...
    iget v1, p0, Lno7;->mBaselineAlignedChildIndex:I
    ...
    iget p0, p0, Lno7;->mBaselineAlignedChildIndex:I
    ...
    :cond_2
    iget v2, p0, Lno7;->mBaselineChildTop:I

    iget v3, p0, Lno7;->mOrientation:I

    const/4 v4, 0x1

    if-ne v3, v4, :cond_5

    iget v3, p0, Lno7;->mGravity:I
    ...
    iget p0, p0, Lno7;->mTotalLength:I
...
.method public getDividerPadding()I
    ...
    iget p0, p0, Lno7;->mDividerPadding:I
...
.method public getDividerWidth()I
    ...
    iget p0, p0, Lno7;->mDividerWidth:I
...
.method public getShowDividers()I
    ...
    iget p0, p0, Lno7;->mShowDividers:I
...
.method public hasDividerBeforeChildAt(I)Z
    ...
    :cond_3
    iget v2, p0, Lno7;->mShowDividers:I
...
.method public isBaselineAligned()Z
    ...
    iget-boolean p0, p0, Lno7;->mBaselineAligned:Z
...
.method public isMeasureWithLargestChildEnabled()Z
    ...
    iget-boolean p0, p0, Lno7;->mUseLargestChild:Z
...
.method public layoutHorizontal(IIII)V
    ...
    invoke-virtual {v0}, Lno7;->getVirtualChildCount()I

    move-result v7

    iget v8, v0, Lno7;->mGravity:I
    ...
    iget-boolean v10, v0, Lno7;->mBaselineAligned:Z

    iget-object v11, v0, Lno7;->mMaxAscent:[I

    iget-object v12, v0, Lno7;->mMaxDescent:[I
    ...
    iget v14, v0, Lno7;->mTotalLength:I
    ...
    iget v15, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v3}, Lno7;->getVirtualChildAt(I)Landroid/view/View;

    move-result-object v13

    if-nez v13, :cond_4

    invoke-virtual {v0, v3}, Lno7;->measureNullChild(I)I
    ...
    :cond_b
    :goto_6
    invoke-virtual {v0, v3}, Lno7;->hasDividerBeforeChildAt(I)Z

    move-result v4

    if-eqz v4, :cond_c

    iget v4, v0, Lno7;->mDividerWidth:I
    ...
    invoke-virtual {v0, v13}, Lno7;->getLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v13}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v13, v3}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
...
.method public layoutVertical(IIII)V
    ...
    iget p2, p0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {p0, p4}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p4}, Lno7;->measureNullChild(I)I
    ...
    :goto_3
    invoke-virtual {p0, p4}, Lno7;->hasDividerBeforeChildAt(I)Z

    move-result v9

    if-eqz v9, :cond_6

    iget v9, p0, Lno7;->mDividerHeight:I
    ...
    invoke-virtual {p0, v3}, Lno7;->getLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v3}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v3, p4}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
...
.method public measureHorizontal(II)V
    ...
    iput v7, v0, Lno7;->mTotalLength:I
    ...
    iget-object v1, v0, Lno7;->mMaxAscent:[I

    const/4 v11, 0x4

    if-eqz v1, :cond_0

    iget-object v1, v0, Lno7;->mMaxDescent:[I
    ...
    iput-object v1, v0, Lno7;->mMaxAscent:[I

    new-array v1, v11, [I

    iput-object v1, v0, Lno7;->mMaxDescent:[I

    :cond_1
    iget-object v12, v0, Lno7;->mMaxAscent:[I

    iget-object v13, v0, Lno7;->mMaxDescent:[I
    ...
    iget-boolean v1, v0, Lno7;->mBaselineAligned:Z

    iget-boolean v2, v0, Lno7;->mUseLargestChild:Z
    ...
    invoke-virtual {v0, v2}, Lno7;->getVirtualChildAt(I)Landroid/view/View;

    move-result-object v1

    if-nez v1, :cond_3

    iget v1, v0, Lno7;->mTotalLength:I

    invoke-virtual {v0, v2}, Lno7;->measureNullChild(I)I

    move-result v6

    add-int/2addr v6, v1

    iput v6, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v1, v2}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    :cond_4
    invoke-virtual {v0, v2}, Lno7;->hasDividerBeforeChildAt(I)Z

    move-result v6

    if-eqz v6, :cond_5

    iget v6, v0, Lno7;->mTotalLength:I

    iget v7, v0, Lno7;->mDividerWidth:I
    ...
    iget v5, v0, Lno7;->mTotalLength:I
    ...
    :cond_6
    iget v3, v0, Lno7;->mTotalLength:I
    ...
    iput v3, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual/range {v0 .. v6}, Lno7;->measureChildBeforeLayout(Landroid/view/View;IIIII)V
    ...
    invoke-virtual {v0, v3}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    iput v9, v0, Lno7;->mTotalLength:I
    ...
    iput v5, v0, Lno7;->mTotalLength:I
    ...
    :goto_d
    invoke-virtual {v0, v3, v2}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    iget v2, v0, Lno7;->mTotalLength:I

    move/from16 v7, v35

    if-lez v2, :cond_16

    invoke-virtual {v0, v7}, Lno7;->hasDividerBeforeChildAt(I)Z
    ...
    iget v3, v0, Lno7;->mDividerWidth:I

    add-int/2addr v2, v3

    iput v2, v0, Lno7;->mTotalLength:I
    ...
    iget v4, v0, Lno7;->mTotalLength:I
    ...
    iput v8, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v4, v3}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    iget v9, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v4}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    iput v4, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v12}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v14}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    iput v15, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v6}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
...
.method public measureVertical(II)V
    ...
    iget v11, v0, Lno7;->mBaselineAlignedChildIndex:I

    iget-boolean v12, v0, Lno7;->mUseLargestChild:Z
    ...
    iget v14, v0, Lno7;->mDividerHeight:I
    ...
    iput v5, v0, Lno7;->mBaselineChildTop:I
    ...
    invoke-virtual {v0, v6}, Lno7;->hasDividerBeforeChildAt(I)Z
    ...
    iget v4, v0, Lno7;->mDividerHeight:I
    ...
    invoke-virtual {v0, v4}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Lno7;->measureNullChild(I)I

    move-result v11

    add-int/2addr v11, v5

    iput v11, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v5, v4}, Lno7;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    iget v13, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v5}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    iget v11, v0, Lno7;->mTotalLength:I
    ...
    iput v10, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v5}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
    ...
    :goto_18
    iget v10, v0, Lno7;->mTotalLength:I
    ...
    invoke-virtual {v0, v12}, Lno7;->getNextLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v7}, Lno7;->getVirtualChildAt(I)Landroid/view/View;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget v0, p0, Lno7;->mOrientation:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_1

    invoke-virtual {p0, p1}, Lno7;->drawDividersVertical(Landroid/graphics/Canvas;)V

    return-void

    :cond_1
    invoke-virtual {p0, p1}, Lno7;->drawDividersHorizontal(Landroid/graphics/Canvas;)V
...
.method public onLayout(ZIIII)V
    ...
    iget p1, p0, Lno7;->mOrientation:I

    const/4 v0, 0x1

    if-ne p1, v0, :cond_0

    invoke-virtual {p0, p2, p3, p4, p5}, Lno7;->layoutVertical(IIII)V

    return-void

    :cond_0
    invoke-virtual {p0, p2, p3, p4, p5}, Lno7;->layoutHorizontal(IIII)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {p0, p1, p2}, Lno7;->measureVertical(II)V

    return-void

    :cond_0
    invoke-virtual {p0, p1, p2}, Lno7;->measureHorizontal(II)V
...
.method public setBaselineAligned(Z)V
    ...
    iput-boolean p1, p0, Lno7;->mBaselineAligned:Z
...
.method public setBaselineAlignedChildIndex(I)V
    ...
    iput p1, p0, Lno7;->mBaselineAlignedChildIndex:I
...
.method public setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Lno7;->mDivider:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, p0, Lno7;->mDividerWidth:I

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v1

    iput v1, p0, Lno7;->mDividerHeight:I

    goto :goto_0

    :cond_1
    iput v0, p0, Lno7;->mDividerWidth:I

    iput v0, p0, Lno7;->mDividerHeight:I
...
.method public setDividerPadding(I)V
    ...
    iput p1, p0, Lno7;->mDividerPadding:I
...
.method public setMeasureWithLargestChildEnabled(Z)V
    ...
    iput-boolean p1, p0, Lno7;->mUseLargestChild:Z
...
.method public setOrientation(I)V
    ...
    iput p1, p0, Lno7;->mOrientation:I
...
.method public setShowDividers(I)V
    ...
    iget v0, p0, Lno7;->mShowDividers:I
    ...
    :cond_0
    iput p1, p0, Lno7;->mShowDividers:I
