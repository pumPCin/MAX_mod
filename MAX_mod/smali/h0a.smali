...
.method public final b(Lyvg;)V
    ...
    iget-object v2, v0, Ly0a;->c:Ljava/lang/Object;
    ...
    iget-object v3, v0, Lh0a;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v3, v1}, Lry6;->d(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, Lg0a;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    invoke-static {v3}, Lty6;->c(Ljava/lang/Object;)I
    ...
    iget-object v7, v0, Lh0a;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_6
    :goto_1
    iget-boolean v3, v0, Lh0a;->g:Z

    if-eqz v3, :cond_8

    iget-object v3, v0, Lh0a;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lf0a;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_8
    :goto_2
    iget-boolean v1, v0, Ly0a;->a:Z

    if-eqz v1, :cond_9

    iget-object v0, v0, Ly0a;->d:Ljava/lang/Object;
    ...
    invoke-static {v2, v0}, Lg0a;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lg0a;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
