...
.method public constructor <init>(Landroid/graphics/drawable/BitmapDrawable;II)V
    ...
    iput-object p1, p0, Ljva;->X:Landroid/graphics/Matrix;
    ...
    iput-object p1, p0, Ljva;->r0:Landroid/graphics/Matrix;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Ljva;->s0:Landroid/graphics/RectF;
...
.method public final d(Landroid/graphics/Matrix;)V
    ...
    iget-object p0, p0, Ljva;->X:Landroid/graphics/Matrix;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Ljva;->X:Landroid/graphics/Matrix;
...
.method public final getIntrinsicHeight()I
    ...
    :cond_0
    invoke-super {p0}, Lr66;->getIntrinsicHeight()I
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v6, p0, Ljva;->X:Landroid/graphics/Matrix;
    ...
    :goto_1
    iget-object v1, p0, Ljva;->r0:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    invoke-virtual {v6, v1}, Landroid/graphics/Matrix;->invert(Landroid/graphics/Matrix;)Z

    iget-object p0, p0, Ljva;->s0:Landroid/graphics/RectF;
