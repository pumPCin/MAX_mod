...
.method public static b(Landroid/view/View;Lvug;Landroid/graphics/Rect;)Lvug;
    .registers 4
...
.method public static j(Landroid/view/View;)Lvug;
    .registers 8

    sget-boolean v0, Ljug;->d:Z
    ...
    :try_start_0
    sget-object v2, Ljug;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Ljug;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Ljug;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, Lh97;->b(IIII)Lh97;

    move-result-object v2

    invoke-virtual {v3, v2}, Lkug;->i(Lh97;)V
    ...
    invoke-static {v2, v4, v5, v0}, Lh97;->b(IIII)Lh97;

    move-result-object v0

    invoke-virtual {v3, v0}, Lkug;->f(Lh97;)V

    invoke-virtual {v3}, Lkug;->b()Lvug;

    move-result-object v0

    iget-object v2, v0, Lvug;->a:Ltug;

    invoke-virtual {v2, v0}, Ltug;->q(Lvug;)V
    ...
    invoke-virtual {v2, p0}, Ltug;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Lz8a;)V
    .registers 4
    ...
    invoke-direct {v0, p0, p1}, Lv6g;-><init>(Landroid/view/View;Lz8a;)V
