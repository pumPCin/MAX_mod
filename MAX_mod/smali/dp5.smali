...
.method public static I(Ljava/io/File;)Z
    ...
    invoke-direct {v0, p0}, Lzn5;-><init>(Ljava/io/File;)V

    new-instance p0, Lxn5;

    invoke-direct {p0, v0}, Lxn5;-><init>(Lzn5;)V
...
.method public static J(Ljava/io/File;)[B
    ...
    invoke-static {v0, v6}, Lmq0;->n(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static K(Ljava/io/File;)Ljava/util/ArrayList;
    .registers 7
    ...
    invoke-direct {p0, v0, v3}, Lzr;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lnl3;

    invoke-direct {v0, p0}, Lnl3;-><init>(Lbid;)V

    invoke-virtual {v0}, Lnl3;->iterator()Ljava/util/Iterator;
...
.method public static L(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lvkf;->y(Ljava/io/Reader;)Ljava/lang/String;
...
.method public static M(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v1, v2, v3}, Ljme;->n0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v1, v4, v3}, Ljme;->n0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p0, v1}, Ljme;->g0(Ljava/lang/String;C)Z
...
.method public static N(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Ldp5;->O(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
