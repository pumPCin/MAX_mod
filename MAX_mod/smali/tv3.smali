...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ltv3;->X:Landroid/content/ContentResolver;
...
.method public final G(Ln74;)J
    ...
    :try_start_0
    iget-object v4, v1, Ln74;->a:Landroid/net/Uri;

    iget-wide v5, v1, Ln74;->g:J

    iget-wide v7, v1, Ln74;->f:J

    invoke-virtual {v4}, Landroid/net/Uri;->normalizeScheme()Landroid/net/Uri;

    move-result-object v4

    iput-object v4, v0, Ltv3;->Y:Landroid/net/Uri;
    ...
    iget-object v10, v0, Ltv3;->X:Landroid/content/ContentResolver;
    ...
    :goto_0
    iput-object v9, v0, Ltv3;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v0, Ltv3;->r0:Ljava/io/FileInputStream;
    ...
    :goto_3
    iput-wide v3, v0, Ltv3;->s0:J

    :cond_7
    const/4 v9, 0x1

    iput-boolean v9, v0, Ltv3;->t0:Z
...
.method public final close()V
    ...
    iput-object v0, p0, Ltv3;->Y:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Ltv3;->r0:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Ltv3;->r0:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Ltv3;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Ltv3;->Z:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Ltv3;->t0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Ltv3;->t0:Z
    ...
    :try_start_4
    iget-object v4, p0, Ltv3;->Z:Landroid/content/res/AssetFileDescriptor;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Ltv3;->Y:Landroid/net/Uri;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Ltv3;->r0:Ljava/io/FileInputStream;
