...
.method public constructor <init>(Lcl7;Lcl7;Lcl7;)V
    ...
    iput-object p3, p0, Lmza;->a:Lcl7;

    iput-object p1, p0, Lmza;->b:Lcl7;

    iput-object p2, p0, Lmza;->c:Lcl7;
    ...
    iput-object p1, p0, Lmza;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lmza;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lmza;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lnr1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lnr1;->s0:Lhrf;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lnr1;->t0:Z

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lmza;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lmza;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lw21;->b()Z

    move-result v2

    check-cast v1, Lnr1;

    iget-object v3, v1, Lnr1;->u0:Lq5g;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lq5g;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lnr1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lmza;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-interface {v0}, Lzg1;->s()Lq5g;

    move-result-object v0

    iget-object v0, v0, Lq5g;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lmza;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lmza;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p2, p2, Lvya;->a:Lkya;

    iget-object p2, p2, Lkya;->a:Lzg1;

    invoke-interface {p2}, Lzg1;->s()Lq5g;

    move-result-object p2

    iget-object p2, p2, Lq5g;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lmza;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Laf1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
